...
function ApiService($http, $q, invoiceFactory) {
  ...
  api.organizacionaJedinica.poId.izmijeni =
    api__organizaciona_jedinica__po_id__izmijeni;

  api.api__frontend__initial = api__frontend__initial;
  api.api__frontend__artikal__unos = api__frontend__artikal__unos;
  api.api__frontend__artikal__po_id__izmijeni =
    api__frontend__artikal__po_id__izmijeni;
  api.api__frontend__invoice__create__type1 =
    api__frontend__invoice__create__type1;
  api.api__frontend__final_invoice__create =
    api__frontend__final_invoice__create;
  api.api__frontend__invoice__regular__all =
    api__frontend__invoice__regular__all;
  api.api__frontend__invoice__order__all = api__frontend__invoice__order__all;
  api.api__frontend__invoice__advance__all =
    api__frontend__invoice__advance__all;
  api.api__frontend__invoice__template__all =
    api__frontend__invoice__template__all;
  ...
  api.api__order__listaj = api_order_listaj;
  ...
  api.faktura.poId.invoice_schedule.add =
  ...
  api.dospjelaFaktura.notifikacija.listaj =
    apiDospjelaFakturaNotifikacijaListaj;
  ...
  function api__organizaciona_jedinica__po_id__izmijeni(
    ...
    return _getRequest({
      method: "POST",
      url:
        "/api/customer/organizaciona_jedinica/" +
        organizacionaJedinicaId +
        "/izmijeni",
      data: data,
    });
  ...
  function api__frontend__invoice__create__type1(invoice_template_id) {
    let url = new URL(
      "/api/customer/frontend/invoice/create/type1",
  ...
  function api__frontend__final_invoice__create(advance_invoice_id) {
    let url = new URL(
      "/api/customer/frontend/final_invoice/create",
      document.location.origin
    );
  ...
  function api__final_invoice__create(
    final_invoice,
    corrected_advance_invoice,
  ...
  function api_order_listaj(
    upitZaPretragu,
    brojStavkiPoStranici,
    brojStranice
  ) {
    if (upitZaPretragu) {
  ...
  function api__faktura__po_id__koriguj(
    fakturaId,
    corrected_invoice,
    corrective_invoice
  ) {
  ...
  function apiGrupaArtikalaPoIdZalihaListaj(grupa_artikala_id) {
    return _getRequest({
      method: "GET",
      url:
        "/api/customer/firma/grupa_artikala/" +
        grupa_artikala_id +
        "/zaliha/listaj",
    });
  }
