...
function routesConfig(
  ...
  $urlRouterProvider.otherwise(
    fisConfigProvider.service.user.podesavanja_aplikacije.pocetna_stranica
  );
    ...
    resolve: {
      initialData: [
        ...
        function ($stateParams, api) {
          return api
            .api__frontend__artikal__po_id__izmijeni($stateParams.id)
            .then(function (data) {
              return data;
            });
        },
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/artikal-pregled-lista/artikal-pregled-lista.template.html",
    ...
    resolve: {
      ...
      strana: [
        ...
        "api",
        "fisConfig",
        function ($stateParams, api, fisConfig) {
  ...
  $stateProvider.state({
    ...
    url: "/credit_note/new",
    templateUrl:
      "app/views/credit-note-create/credit-note-create.template.html",
    controller: "CreditNoteCreateController",
    controllerAs: "ctrl",
    resolve: {
      viewData: [
        "fisCustomerApi",
        function (fisCustomerApi) {
  ...
  $stateProvider.state({
    ...
    resolve: {
      viewData: [
        "$stateParams",
        "fisCustomerApi",
        function ($stateParams, fisCustomerApi) {
          return fisCustomerApi
            .views__credit_note_view__on_load({
              broj_stavki_po_stranici: $stateParams.broj_stavki_po_stranici,
              broj_stranice: $stateParams.broj_stranice,
            })
            .then(function (data) {
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/dospjela-faktura-pregled/dospjela-faktura-pregled.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-konacni-racun/faktura-konacni-racun.template.html",
    ...
    resolve: {
      ...
      initialData: [
        ...
        function ($stateParams, api) {
          return api
            .api__frontend__final_invoice__create(
              $stateParams.advance_invoice_id
            )
            .then(function (data) {
              return data;
            });
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-pregled-avansa/faktura-pregled-avansa.template.html",
    ...
    resolve: {
      ...
      initialData: [
        ...
        "$stateParams",
        "fisInvoiceConfig",
        function ($http, $stateParams, fisInvoiceConfig) {
          let params = {
            broj_stavki_po_stranici:
              $stateParams.broj_stavki_po_stranici ||
              fisInvoiceConfig.itemsPerPage,
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-pregled-redovnih/faktura-pregled-redovnih.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-pregled-porudzbine/faktura-pregled-porudzbine.template.html",
    ...
    resolve: {
      ...
      initialData: [
        ...
        function (api, $stateParams) {
          ...
          return api.api__frontend__invoice__order__all(params);
        },
      ],
    },
  });
  ...
  $stateProvider.state({
    ...
    url: "/advance/create",
    templateUrl:
      "app/views/faktura-slobodan-unos-avansa/faktura-slobodan-unos-avansa.template.html",
    ...
    resolve: {
      ...
      initialData: [
        ...
        function ($stateParams, api) {
          return api
            .api__frontend__invoice__create__type1(
              $stateParams.invoice_template_id
            )
            .then(function (data) {
              return data;
            });
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-slobodan-unos-korekcije/faktura-slobodan-unos-korekcije.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-slobodan-unos-redovnih/faktura-slobodan-unos-redovnih.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/faktura-unos-po-grupama/faktura-unos-po-grupama.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/grupa-artikala-izmjena/grupa-artikala-izmjena.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/grupa-artikala-pregled-lista/grupa-artikala-pregled-lista.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/grupa-artikala-unos/grupa-artikala-unos.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/izvjestaj-dnevni-forma/izvjestaj-dnevni-forma.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/izvjestaj-periodicni-forma/izvjestaj-periodicni-forma.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/izvjestaj-po-artiklima-forma/izvjestaj-po-artiklima-forma.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/izvjestaj-po-grupama-artikala-forma/izvjestaj-po-grupama-artikala-forma.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/izvjestaj-zurnal-forma/izvjestaj-zurnal-forma.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/komitent-pregled-lista/komitent-pregled-lista.template.html",
    ...
    resolve: {
      ...
      strana: [
        ...
        function ($stateParams, fisCustomerApi) {
          return fisCustomerApi
            .views__komitent_pregled_lista__on_load({
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/komitent-pregled-placanja/komitent-pregled-placanja.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/komitent-unos-placanja/komitent-unos-placanja.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/prijemnica-pregled-lista/prijemnica-pregled-lista.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views/profaktura-pregled-redovnih/profaktura-pregled-redovnih.template.html",
  ...
  $stateProvider.state({
    ...
    templateUrl:
      "app/views2/certificates-list-view/certificates-list-view.template.html",
