...
def api__izvjestaj_po__grupama_artikala__param_datum_od__param_datum_do(
        operater,
        firma,
        param_datum_od,
        param_datum_do
    ...
    rezultat = report_opb.izvjestaj_po_grupama_artikala(operater.naplatni_uredjaj_id, param_datum_od, param_datum_do)

    return bottle.template('backend/templates/print/izvjestaj_po_grupama_artikala.html', {
        'stavke': rezultat,
