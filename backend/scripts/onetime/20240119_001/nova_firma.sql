...
SET @firma_pib = '0310981280031';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'TRIFUN FEMIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'FEMIĆA KRŠ';
...
SET @firma_cert_pass = 'gAAAAABlqkDsmGlLR9TkF-jmuyrVOf71B1n-ewoq94N4y3a1Oh5617Vm5N-mjzMNdWIxuSRycw6kWQc2AtdaiIy541Jkq2Lu-g==';
...
SET @organizaciona_jedinica_efi_kod = 'xs187oa279';
SET @organizaciona_jedinica_naziv = 'SZR "AUTO LIMAR TRIFUN"';
SET @organizaciona_jedinica_adresa = 'ZATON 29';
...
SET @naplatni_uredjaj_id = 'ci116is133';
...
SET @operater_kodoperatera = 'je848kk771';
SET @operater_ime = 'TRIFUN FEMIC';
SET @operater_korisnicko_ime = 'trifun';
SET @operater_lozinka = '$pbkdf2-sha256$29000$LAUgBODcW8uZs5bS2tv7/w$fsVH3tSEAJ0eaIlbV5pniQNHTo7vx6FFer.HRklbKwE';
