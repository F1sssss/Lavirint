...
SET @firma_pib = '03632881';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "MOBILE SERVIS SAMRA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'SVETI SAVA BB';
...
SET @firma_cert_pass = 'gAAAAABl1IHnSZDYSBL5xpxDXRhJe9dZN0VHApKOWEO8SnWaKyisxiz06_QIL-BGbbw1RR76zgmaigkAR5bYTBV-lpJDAK1Neg==';
...
SET @organizaciona_jedinica_efi_kod = 'zk592nr531';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'SVETOG SAVE 13';
...
SET @naplatni_uredjaj_id = 'cw017zu192';
...
SET @operater_kodoperatera = 'fw487av833';
SET @operater_ime = 'SEMIR LICINA';
SET @operater_korisnicko_ime = 'semir';
SET @operater_lozinka = '$pbkdf2-sha256$29000$jfFeS.l9jxFCqDVGSMkZww$UHGo4/lmlZahTTom9gBXA2h0JPliRvZ.famCGIOHjjo';
