...
SET @firma_pib = '03629627';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "1.JUL"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MAINSKI PUT 56';
...
SET @organizaciona_jedinica_efi_kod = 'mh441mz329';
...
SET @naplatni_uredjaj_id = 'mj952wf466';
...
SET @operater_kodoperatera = 'xi693zl150';
SET @operater_ime = 'SVETOLIK TODOSIJEVIĆ';
SET @operater_korisnicko_ime = 'svetolik';
SET @operater_lozinka = '$pbkdf2-sha256$29000$BGDs3RsDwJgTYozxntO6Vw$UJZKTbDTMKtIG4fZe0a7sHFDbwEPCC6O5kHLIkc5T58';
