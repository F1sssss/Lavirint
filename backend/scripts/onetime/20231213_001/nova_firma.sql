...
SET @firma_pib = '03606481';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "VODIČ KROZ PRAVILAN RAZVOJ"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MARKA RADOVIĆA BR. 7';
...
SET @firma_cert_pass = 'gAAAAABleYidIZ1OWheLUOgoBYMz27hfevo138EsLxNUoH2Mvz5Jg0zAwZcAI3VySnNQIdNGO_fGZRC-zsVQmlyd6bGH041eEg==';
...
SET @organizaciona_jedinica_efi_kod = 'hn622tz894';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MARKA RADOVIĆA 7';
...
SET @naplatni_uredjaj_id = 'pl340si630';
...
SET @operater_kodoperatera = 'ii344ac059';
SET @operater_ime = 'MILICA LERO';
SET @operater_korisnicko_ime = 'milica';
SET @operater_lozinka = '$pbkdf2-sha256$29000$.x9D6J3z3lur9V7rvTdmTA$xLask/hqZdh3TV/V/lEac2VxN1J5y2eF0nDAhhpKxgE';
