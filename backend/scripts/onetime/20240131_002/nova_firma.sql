...
SET @firma_pib = '03614417';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "TUANATA"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlueV2jnZYMpp2Ra3mXA--YgOnhEpGmDBjVllJ6hN0AxSJh-Fg3t6_KglvczJf8nxvDjBfSIO0QeGsbQQ-cQLkeUuT9g==';
...
SET @organizaciona_jedinica_efi_kod = 'pp763hx406';
...
SET @naplatni_uredjaj_id = 'mx689ok927';
...
SET @operater_kodoperatera = 'qb852xs817';
SET @operater_ime = 'AHMET SEMIZ';
SET @operater_korisnicko_ime = 'ahmet';
SET @operater_lozinka = '$pbkdf2-sha256$29000$g5AyBuCccy5lrLW2FsJY6w$L.hUQzUV/nhadNU97vNZDYfpVhFokd8C8.48p/jHzSA';
