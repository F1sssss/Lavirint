...
SET @firma_pib = '2504972275021';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'SEVDINA KORAĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PETNJICA BB';
SET @firma_grad = 'PETNJICA';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
SET @firma_je_aktivna=1;
SET @firma_cert_pass = 'gAAAAABk334iIy5akhw4-C-yja_Kdk7-rVj2BcqbBhPhE5TU7R_4aj-mqcJUCcLWcRLfVBzCLQQwKNs3qf0ye8F6xwqFMPtvMw==';
...
SET @organizaciona_jedinica_efi_kod = 'mo539fi071';
SET @organizaciona_jedinica_naziv = 'LIS BUTIK';
SET @organizaciona_jedinica_adresa = 'JOHOVICE BB';
SET @organizaciona_jedinica_grad = 'PETNJICA';
...
SET @naplatni_uredjaj_id = 'rr951lp626';
...
SET @operater_kodoperatera = 'qr881zc440';
SET @operater_ime = 'SEVDINA KORAĆ';
SET @operater_korisnicko_ime = 'sevdina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$.p/zfq81JiQEYOz9H2NMSQ$illjbC3ALt3KLxu8G6i4pGNlCL9/SRvHoVqgTLWed3k';
