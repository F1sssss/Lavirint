...
SET @firma_pib = '03459462';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "OUR"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'SUTVARA BB, RADANOVIĆI';
...
SET @organizaciona_jedinica_efi_kod = 'fg789sg052';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MILORADA BB';
...
SET @operater_kodoperatera = 'ix637ae656';
SET @operater_ime = 'Goran Vukšić';
SET @operater_korisnicko_ime = 'goran';
SET @operater_lozinka = '$pbkdf2-sha256$29000$glBqzdlbC8FYyzlHCGGMkQ$SBSTfmAxlvVM47NIwFGFbxYmGGAN99C/jYR1JDvH9ME';
