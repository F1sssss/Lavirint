...
SET @firma_pib = '1502980715247';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'DANICA RADULOVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BALŠIĆA 1';
...
SET @firma_cert_pass = 'gAAAAABkrqkzDhG9gWuxCPKSeXOLLqJv1tzV1D6raAHyUhiDV34qIqdR0_OCyv4wWWb-TvivRnQSbFnULJoeWUfaT82XmJkytg==';
...
SET @organizaciona_jedinica_efi_kod = 'yf505fx450';
SET @organizaciona_jedinica_adresa = 'BRVAČKA ULICA 28';
...
SET @naplatni_uredjaj_id = 'rp405rq018';
...
SET @operater_kodoperatera = 'qs557uo876';
SET @operater_ime = 'DANICA RADULOVIC';
SET @operater_korisnicko_ime = 'danica';
SET @operater_lozinka = '$pbkdf2-sha256$29000$//./V0pJaa11bs3Zu7c2Zg$6B5kdJ0m2vCWYrPCxf2kd90zusBSiUkP.jGCEmIR.Yg';
