...
SET @firma_pib = '03633209';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "LADY D FLOWERS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ŠKALJARI BB';
...
SET @firma_cert_pass = 'gAAAAABl1pCCqfVSneovE4sgQf_KSem9XBcVvAKDWokijXweY53czfEDsYTimi6rjgaz0yA4LCN3_o-88SEw4CiDrcyz9Mm5QA==';
...
SET @organizaciona_jedinica_efi_kod = 'lh278mh482';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'ŠKALJARI BB';
...
SET @naplatni_uredjaj_id = 'xq889dn883';
...
SET @operater_kodoperatera = 'ps782pk280';
SET @operater_ime = 'DAJANA RADONJIC';
SET @operater_korisnicko_ime = 'dajana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$hrD2nlOqtbYWQigFQAjh/A$3XB8geFu99HZlpA6/y8H1qKVeCpY3ZvUgWspzg0h8xg';
