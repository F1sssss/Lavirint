...
SET @firma_pib = '03488845';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "BEREGE.FS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'SOLUNSKIH DOBROVOLJACA BR. 36, BIJELA';
...
SET @firma_cert_pass = 'gAAAAABlqkWnUb5QyzVTZ0ZvONBbiOFqgRvN1PKE47-tK0pDRmw7iTxsIMZvSoP0H46Y54B0VDzHUJEhXBY4psxQCjzFDXIEZQ==';
...
SET @organizaciona_jedinica_efi_kod = 'mx434ld844';
SET @organizaciona_jedinica_naziv = 'Agencija';
SET @organizaciona_jedinica_adresa = 'BIJELA BB';
...
SET @naplatni_uredjaj_id = 'fd177qk937';
...
SET @operater_kodoperatera = 'dc453xd350';
SET @operater_ime = 'Mirko Peruničić';
SET @operater_korisnicko_ime = 'mirko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$1VqrNabUGkMIIYRQ6l2LMQ$iQaIL80Hd8Wt2a1sJrbCLVnWbsftvmjOmOeeXe8wQrw';
