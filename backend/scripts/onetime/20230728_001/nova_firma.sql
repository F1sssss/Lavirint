...
SET @firma_pib = '03307352';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "INVESTINMNE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BULEVAR DŽORDŽA VAŠINGTONA 52';
...
SET @firma_cert_pass = 'gAAAAABkw5_zrZXwS-WkyZz6abMGUAgTYy4DrF-c8tPRqLgwYlcdR1oJGRCMS2-3O27fXi2B8GMtw5p_Q-DnKJxWHk7hYr6kWA==';
...
SET @organizaciona_jedinica_efi_kod = 'uc086ae402';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BULEVAR DŽORDŽA VAŠINGTONA 52';
...
SET @naplatni_uredjaj_id = 'qf690ow015';
...
SET @operater_kodoperatera = 'do578vr857';
SET @operater_ime = 'IVAN ĆAĆIĆ';
SET @operater_korisnicko_ime = 'ivan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$Oed87x3jPAcAAIAQImRsrQ$OFdOxLceV.VHzpUselY.rvZ4o7louVEF0ZZYKBfBqYo';
