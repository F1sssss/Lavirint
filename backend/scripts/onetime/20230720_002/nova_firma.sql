...
SET @firma_pib = '03477061';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "VERTEX MNE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BABILONIJA 53';
...
SET @firma_cert_pass = 'gAAAAABkuGL-G_r_nEpMn51_RLq8vC2xWdhw4ATZdenC8X1f5mDAbC57kpTjjH8uAkJhwRkbaMuSdpKDwzv0r1t7iDsel4onEQ==';
...
SET @organizaciona_jedinica_efi_kod = 'gf876fv336';
SET @organizaciona_jedinica_naziv = 'VERTEX MONTE';
SET @organizaciona_jedinica_adresa = 'HERCEG NOVI BB';
...
SET @naplatni_uredjaj_id = 'er141ye074';
...
SET @operater_kodoperatera = 'yn027nu696';
SET @operater_ime = 'IVAN MIKHALEV';
SET @operater_korisnicko_ime = 'ivan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$BSCkNKZUqtV6711rjRFC6A$vSaFyb5b5i4YpV7oWSuvIZ1mluPGEJSu/1lDAV8LF1o';
