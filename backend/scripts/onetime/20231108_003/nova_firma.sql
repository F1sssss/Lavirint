...
SET @firma_pib = '02441420';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "PAVIĆ COMPANY"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DONJE POLJE BR. 46';
SET @firma_grad = 'CETINJE';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
SET @firma_je_aktivna = 1;
SET @firma_cert_pass = 'gAAAAABlS6-NsoFvs3aVIH8CockowMUep38xCjEaY05A_6al0Wyz_s2MnpBrplsDUgE7KyoTshF4Z4qnc7BRq6NyIOakwVRGPQ==';
...
SET @organizaciona_jedinica_efi_kod = 'bm853je152';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'GRUDA – DONJE POLJE 46';
SET @organizaciona_jedinica_grad = 'CETINJE';
...
SET @naplatni_uredjaj_id = 'sx366er134';
...
SET @operater_kodoperatera = 'yv698gn170';
SET @operater_ime = 'NIKOLA PAVICEVIC';
SET @operater_korisnicko_ime = 'nikola';
SET @operater_lozinka = '$pbkdf2-sha256$29000$I4SQcq51bq3VmtO6V6r1ng$Nb4taCpIOUdsIP0R9ma1a5blay6xL4bXWmqnQhz2LjI';
