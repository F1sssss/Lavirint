...
SET @firma_pib = '02975777';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "MMB BORIČIĆ"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'UL. DUNOVSKA BR.24';
...
SET @firma_cert_pass = 'gAAAAABltMDH8d3RrJsMrpmT1Xp8Fi1qnPOSOLitr7pFse49Or5hKU_p3edpAMlGk5nsGKlTTqA_-fI_tjmffAGmaHeCEgdNjw==';
...
SET @organizaciona_jedinica_efi_kod = 'uy016zf572';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'DUNAVSKA 24';
...
SET @naplatni_uredjaj_id = 'is736sw480';
...
SET @operater_kodoperatera = 'na151cf839';
SET @operater_ime = 'MILOS BORICIC';
SET @operater_korisnicko_ime = 'milos';
SET @operater_lozinka = '$pbkdf2-sha256$29000$7j1njPF.b41xLqWUco6x1g$sEQmu5/HpMb/Z3j8udlevndoSSn5vbEyh5OwCq8ssIo';
