...
SET @firma_pib = '03584887';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "ALFA INVESTMENT"';
SET @firma_pdvbroj = '';
...
SET @organizaciona_jedinica_efi_kod = 'ws770zc664';
...
SET @naplatni_uredjaj_id = 'wa674vf741';
...
SET @operater_kodoperatera = 'qv942ap844';
SET @operater_ime = 'EMRE DEVELI';
SET @operater_korisnicko_ime = 'emre';
SET @operater_lozinka = '$pbkdf2-sha256$29000$TUkJgdCaEwIAgPB.D0Fo7Q$y1Ow/znpyLgZ5KMYdrsjTwEeVoY871iZB9A57s9o94k';
