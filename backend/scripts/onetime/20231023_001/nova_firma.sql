...
SET @firma_pib = '03605442';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "KAFORM"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NOVOSADSKA 1-B';
...
SET @firma_cert_pass = 'gAAAAABlNlJo60rsCRNDP6rSvtmxPGG7vprz9NT-EiG6YoMeLceydXxseXclSEwsSq6pdi4nm-8B2kGwbSxK67QRVxSICqMd4A==';
...
SET @organizaciona_jedinica_efi_kod = 'rb910ne419';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NOVOSADSKA 1';
...
SET @naplatni_uredjaj_id = 'sw082rs459';
...
SET @operater_kodoperatera = 'na083dk170';
SET @operater_ime = 'PIOTR RYSZARD OSLIZLO';
SET @operater_korisnicko_ime = 'piotr';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xzgnxHjP2RtjDCFEqHVOaQ$OLx5S2YLntTPuFwvR3EyZ/0mZY1b3eu0XBAsVoEVz0s';
