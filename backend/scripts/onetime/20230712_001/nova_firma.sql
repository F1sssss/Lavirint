...
SET @firma_pib = '02641763';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ZOPCAR"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BULJARICA B.B.';
...
SET @firma_cert_pass = 'gAAAAABkrldjyhI5Ya3KH0MLEvqme19BU99FkBS-y4LisLH-PAG2EUqAPakQtZxgLNPl_aHo2zTRrMzl1pkS_zxLz_gux7zbuA==';
...
SET @organizaciona_jedinica_efi_kod = 'hu281fz528';
SET @organizaciona_jedinica_adresa = 'PETROVAC BB';
...
SET @naplatni_uredjaj_id = 'px673uk262';
...
SET @operater_kodoperatera = 'le018ls237';
SET @operater_ime = 'ZORAN PEROVIĆ';
SET @operater_korisnicko_ime = 'zoran';
SET @operater_lozinka = '$pbkdf2-sha256$29000$3dtbqzUmROgdo9T6P4eQEg$uYImHs89czACPLzM4i6z37e6X3dkUgC2oMRRhBm08NQ';
