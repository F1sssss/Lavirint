...
SET @firma_pib = '0109986275020';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'MIRJANA ZEČEVIĆ';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlRR7fS-ldmGUCFKGJQpfathDUZX6EydsZUaONhVtEMRgeS7em_oXNmHltoqGDlFPOZsWfyij3LBieEdjwTFLEIYSuuw==';
...
SET @organizaciona_jedinica_efi_kod = 'sh661jh144';
SET @organizaciona_jedinica_naziv = 'KOZMETIČKI SALON "MIRISKIN"';
SET @organizaciona_jedinica_adresa = 'SVETOG SAVE BB';
...
SET @naplatni_uredjaj_id = 'vj233tr717';
...
SET @operater_kodoperatera = 'mn083uk375';
SET @operater_ime = 'MIRJANA ZEČEVIĆ';
SET @operater_korisnicko_ime = 'mirjana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$m/Pe.z9HqFVqTSnlPGeMkQ$OM.tnBuxxBglPXaZMFijjffrZ5.PTDvm8leuTyQ7P8w';
