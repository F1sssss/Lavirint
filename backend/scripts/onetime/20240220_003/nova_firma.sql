...
SET @firma_pib = '03634027';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "BV CONNECT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ULICE VOJVODE MIRKA PETROVIĆA BB';
...
SET @firma_cert_pass = 'gAAAAABl1LLyX_7J1Vs4BCppnlqiVwo7xZXksX1jtW_k1So1HZZ9N9xoN-5PndcLw4WNuMffRCOnATdDp5Chn2rNOoYhkEB0sg==';
...
SET @organizaciona_jedinica_efi_kod = 'gm135pz632';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'VOJVODE MIRKA PETROVIĆA BB';
...
SET @naplatni_uredjaj_id = 'sv434ff406';
...
SET @operater_kodoperatera = 'co809gt085';
SET @operater_ime = 'JELENA VUKSANOVIC';
SET @operater_korisnicko_ime = 'jelena';
SET @operater_lozinka = '$pbkdf2-sha256$29000$NSaEMCaEcE7pvdf6H0PonQ$Bow/NGHxEO8iRYMfab/gUTQEbCW4eBY.PboNZG4VQP8';
