...
SET @firma_pib = '0812974270018';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'RADONJA CELIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BUDIMLJA BB';
...
SET @firma_cert_pass = 'gAAAAABl0kM8kl0BuW8cS0RQgfZcsFhJcEnVKOPGwT38bp32l8pOVXYqV12uO7oXeCLNpIhxG93cwIZhIEj2ITil-k8NCBQ3Gg==';
...
SET @organizaciona_jedinica_efi_kod = 'zz869hh034';
...
SET @naplatni_uredjaj_id = 'sk297nf836';
...
SET @operater_kodoperatera = 'bg425lc328';
SET @operater_ime = 'RADONJA CELIC';
SET @operater_korisnicko_ime = 'radonja';
SET @operater_lozinka = '$pbkdf2-sha256$29000$gNDa.x8DYKx17j0HAKBUag$rwncGyFJDwsJC9BF09U6BnvXnH2DO/.148A.7izX88Y';
