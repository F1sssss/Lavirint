...
SET @firma_pib = '1206993939863';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'SANELA PILAV';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'OSLOBOĐENJA 166';
...
SET @organizaciona_jedinica_efi_kod = 'od234oa095';
SET @organizaciona_jedinica_naziv = 'FRIZERSKI SALON "F BEAUTY HOUSE"';
SET @organizaciona_jedinica_adresa = 'OSLOBOĐENJA 166';
...
SET @naplatni_uredjaj_id = 'fq751me343';
...
SET @operater_kodoperatera = 'ip302ct828';
SET @operater_ime = 'SANELA PILAV';
SET @operater_korisnicko_ime = 'sanela';
SET @operater_lozinka = '$pbkdf2-sha256$29000$cG6NMUYI4TznfC8FgJCy9g$HQwuEfWN.uNx7WDNLjuStRvbrvlghwOmSJdgbR9qLaA';
