...
SET @firma_pib = '03590143';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "BIHORKA POPČA"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlAxettMcSW8cPA_ss0hm9aDtNvxOaASQUM4aiM9Z4Guywv-NZiBaco7Jd6-N2UqKaJZTGMY4GTlB_-4nx6hUINoCpOw==';
...
SET @organizaciona_jedinica_efi_kod = 'ns048ou091';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'PETNJICA BB';
...
SET @naplatni_uredjaj_id = 'fm930cx686';
...
SET @operater_kodoperatera = 'vj794lg921';
SET @operater_ime = 'ELVER RAMDEDOVIĆ';
SET @operater_korisnicko_ime = 'elver';
SET @operater_lozinka = '$pbkdf2-sha256$29000$pdS6N2aMkZISwjjnPAeAEA$t6X6q6smtGtObs9hbCkfboHNDKiJMXdzb1pR.O2MTQw';
