...
SET @firma_pib = '03510760';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "TEHNO - ELECTRO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILORADA ŠĆEPANOVIĆA LAMELA 7';
...
SET @organizaciona_jedinica_efi_kod = 'jl342rl053';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MILORADA ŠĆEPANOVIĆA 7';
...
SET @naplatni_uredjaj_id = 'mj435vj991';
...
SET @operater_kodoperatera = 'jb700lh196';
SET @operater_ime = 'Janko Joksimović';
SET @operater_korisnicko_ime = 'janko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$prR2bu0dY2xNCWGs9d5byw$6j7PZ9/vBIt7rC3zd2guc1w81EBJtDHQTgABC92BVTM';
