...
SET @firma_pib = '0808970240028';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'GEORG KUKOLJAC';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BRAĆE GRBIĆA 58';
...
SET @firma_cert_pass = 'gAAAAABk0LaDUzXWxbAskHPb7MjnA36Zx-FbqYHVNttzDfo_L3SYyjPe6A09EKcEbz3i2RlbmKcOeTPk9WnkK1_GHlbk8crFhQ==';
...
SET @organizaciona_jedinica_efi_kod = 'ec310rg763';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA 111/A';
...
SET @naplatni_uredjaj_id = 'pw042vs054';
...
SET @operater_kodoperatera = 'ni782dr491';
SET @operater_ime = 'GEORG KUKOLJAC';
SET @operater_korisnicko_ime = 'georg';
SET @operater_lozinka = '$pbkdf2-sha256$29000$wzhnzFmrFcKY856zltJaCw$LPfvHtwZTtyzjezwJOSYwlqlx/ARJe.tH01wcLx28mg';
