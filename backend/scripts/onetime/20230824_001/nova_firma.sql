...
SET @firma_pib = '02459167';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "EKO MORAVAC"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TRŠOVA B.B.';
...
SET @firma_cert_pass = 'gAAAAABk5zAM_n7dVDDlQf63UpCmJIzhAwL4f9mJBwHrmb9-GKcXIQsYeQFXyMCsr-2jPATld8T4I7RDHUvA6FM2IF8veMMVSg==';
...
SET @organizaciona_jedinica_efi_kod = 'ph008nt363';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'TRSOVA BB';
...
SET @naplatni_uredjaj_id = 'hg987ea122';
...
SET @operater_kodoperatera = 'fu301sd035';
SET @operater_ime = 'ADNAN DIZDAREVIC';
SET @operater_korisnicko_ime = 'adnan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$SYnxnlPKmbMWwnivlRIipA$sPbIoJVpCfNNAULej.5KCaEho6Ih6hPetTPjBoLpCKk';
