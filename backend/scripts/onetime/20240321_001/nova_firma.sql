...
SET @firma_pib = '03613267';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "RUZGAR COMPANY"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA 136';
...
SET @organizaciona_jedinica_efi_kod = 'nf522wn800';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA 136';
...
SET @naplatni_uredjaj_id = 'oi840cy662';
...
SET @operater_kodoperatera = 'xq367ww792';
SET @operater_ime = 'FUAT AKSU';
SET @operater_korisnicko_ime = 'fuat';
SET @operater_lozinka = '$pbkdf2-sha256$29000$B8DYu7f2/h/j3Ls3xlhL6Q$pWKiEgsQuc9yAQHf4MWxotW6QDViWy47ZSdNiteMKjY';
