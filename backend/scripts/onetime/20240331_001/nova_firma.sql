...
SET @firma_pib = '1508999295018';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "IRMA PRLJAČA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA 9';
...
SET @organizaciona_jedinica_efi_kod = 'yc923be142';
SET @organizaciona_jedinica_naziv = 'IRMA HAIR STUDIO';
SET @organizaciona_jedinica_adresa = 'KRALJA PETRA I';
...
SET @naplatni_uredjaj_id = 'tp548wr307';
...
SET @operater_kodoperatera = 'qd001ez169';
SET @operater_ime = 'IRMA PRLJAČA';
SET @operater_korisnicko_ime = 'irma';
SET @operater_lozinka = '$pbkdf2-sha256$29000$eG.NEUJIyRnD.D/HOKf03g$kkoSdQUa48izCzqWlx4VhPlfGVkG9MKvvm17i5Np8T4';
