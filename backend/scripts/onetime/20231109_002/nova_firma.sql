...
SET @firma_pib = '03606791';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "PERFECT SERVICE TEAM"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MOSORSKA BB';
...
SET @firma_cert_pass = 'gAAAAABlTmcJkyBN3dmRbr8GPQe1vnMFA5Ict2G_dRE7cow6MIeeJ3YdZ5IdUd7Z6cxFL0ZUFx9Y6JDsuJ53Z0RPj88jK9QcrA==';
...
SET @organizaciona_jedinica_efi_kod = 'ym221hm132';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MOSORSKA BB';
...
SET @naplatni_uredjaj_id = 'qb626ej513';
...
SET @operater_kodoperatera = 'bf868ms693';
SET @operater_ime = 'BOZIDAR CICMIL';
SET @operater_korisnicko_ime = 'bozidar';
SET @operater_lozinka = '$pbkdf2-sha256$29000$GeP8/3/POQdA6F3r3bvXmg$L5GKACZ6GuhCAzBf8CSA.OIbXxJuEC2RooUi4zEXa5I';
