...
SET @firma_pib = '03368211';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "VUKODO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NORVEŠKO NASELJE BR.2';
...
SET @firma_cert_pass = 'gAAAAABkvx3M-ek3IZR8xETWla9M8WfMmjVXUNCYqos9ilm0hGwfVxa-CQ--us4k2EfcvhYfffHhXly91iai-EeA3MVC2in_5w==';
...
SET @organizaciona_jedinica_efi_kod = 'fe336xg388';
SET @organizaciona_jedinica_naziv = 'Ulična prodaja';
SET @organizaciona_jedinica_adresa = 'BAOŠIĆI BB';
...
SET @naplatni_uredjaj_id = 'of571sz714';
...
SET @operater_kodoperatera = 'vz884xi478';
SET @operater_ime = 'VESELIN KRIVOKAPIĆ';
SET @operater_korisnicko_ime = 'veselin';
SET @operater_lozinka = '$pbkdf2-sha256$29000$JcRYC.Fca631vjcG4DwHoA$P0mHv6Ek/aR8PseyZ6rVVdm6HUmByiwk/j.53AwhuQA';
