...
SET @firma_pib = '0805991235025';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'SNEŽANA NIKČEVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BRAĆE GRBIĆA 178';
...
SET @firma_cert_pass = 'gAAAAABlxd7ApJKRh2-KxRuwIArMlDLfzaLmHufmrwFsHrVgQvhjKaiWoKx1SB05_nzzubHoVPX8q7LKxRwnccCkMOGqFqtfEQ==';
...
SET @organizaciona_jedinica_efi_kod = 'fu117le449';
SET @organizaciona_jedinica_naziv = 'Samousluzna perionica';
SET @organizaciona_jedinica_adresa = 'BRAĆE GRBIĆA 178';
...
SET @naplatni_uredjaj_id = 'wt067cq870';
...
SET @operater_kodoperatera = 'ak654fm930';
SET @operater_ime = 'Snezana Nikcevic';
SET @operater_korisnicko_ime = 'snezana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$/x8jpBRi7D1nzBmDkHIOgQ$4gbM5veil1e8Y.WUFQYDw7LtA8tpiei7twlupAdTqlM';
