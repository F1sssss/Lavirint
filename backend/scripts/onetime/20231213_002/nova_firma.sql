...
SET @firma_pib = '03617262';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "MOJ ZEN"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BULEVAR IVANA CRNOJEVIĆA 123';
...
SET @firma_cert_pass = 'gAAAAABleawt6S7o7Hu1-Wp5hXYJ-aMYdKxMX-qy0EHcRJEq1809v3_KrfWaioVBgyTGtmJDU3TYT43JqrCX0lMm_5gp0e0uXQ==';
...
SET @organizaciona_jedinica_efi_kod = 'gh382qe520';
SET @organizaciona_jedinica_naziv = 'MOJ ZEN BEAUTY AND BODY';
SET @organizaciona_jedinica_adresa = 'BULEVAR IVANA CRNOJEVIĆA 123';
...
SET @naplatni_uredjaj_id = 'ga165bz638';
...
SET @operater_kodoperatera = 'jw211vb703';
SET @operater_ime = 'IVA VUKOVIC';
SET @operater_korisnicko_ime = 'iva';
SET @operater_lozinka = '$pbkdf2-sha256$29000$HAMgJISQ0nqvtRYiJKQU4g$hhYVnM8XVoVy8U5taUNody0YXNUvZ8cZGiQAWPtDKGQ';
...
SET @operater_kodoperatera = 'jk061ix908';
SET @operater_ime = 'NIKOLINA MAROVIC';
SET @operater_korisnicko_ime = 'nikolina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$mtN6j9Ga01or5RwjBIAQog$QHQqHdNzDymht/viSvvfnpl7UKySlNkQdzVHMNy7ki4';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
