...
SET @firma_pib = '03620891';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "DEDAX"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PETRA MILJANIĆA BR. 2';
...
SET @firma_cert_pass = 'gAAAAABljYw5lc9j2yTms5P-ANnB09osQftVMirxLbj_hkjCXasCaDF4JFUcvKmNCjv1PBmJAAouTa3ZF80qXPlGFeq_gZHgwg==';
...
SET @organizaciona_jedinica_efi_kod = 'nw693vl492';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'DR.PETRA MILJANIĆA';
...
SET @naplatni_uredjaj_id = 'gi308if591';
...
SET @operater_kodoperatera = 'me795wn014';
SET @operater_ime = 'LUKA DEDAIC';
SET @operater_korisnicko_ime = 'luka';
SET @operater_lozinka = '$pbkdf2-sha256$29000$XqtVaq31XgvBeI/ROofQug$LokMUfHp6w2En1.zwQdGoQLNCfrvrPxQ0d.iNrmXITA';
