...
SET @firma_pib = '03596036';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "GRAND EXPRESS"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlppWnO9fWdzLKt6UKbBzoDuu3wcYuxmhjvjNY4ydCDmhrr8UUeSvBW6mbUjnh9HbSC94Oj--gN1AZeZ6083Jh6JJYHQ==';
...
SET @organizaciona_jedinica_efi_kod = 'qb426mc499';
...
SET @naplatni_uredjaj_id = 'mt265yj938';
...
SET @operater_kodoperatera = 'bd783uw105';
SET @operater_ime = 'STEFAN KASTRATOVIC';
SET @operater_korisnicko_ime = 'stefan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$jBHC2Hvvvbf2HqN0LiVEiA$tbLEh9kj7KmQjF7YA4UXt0.UAqQnEwZcSDT4Ej8bE0I';
