...
SET @firma_pib = '03574610';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "FARM IKOVIĆ"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BOHINJSKA BR.36';
...
SET @firma_cert_pass = 'gAAAAABkv3pdbpzPgy-xDKSdTRv_9waCT8OAPv2v29Jw7sUn_Lu4i7UaRpBJXOPSbC957WRkHAUpc72wfV7_3K3guXuKzI6xIw==';
...
SET @organizaciona_jedinica_efi_kod = 'kx059mk933';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BOHINJSKA 6';
...
SET @naplatni_uredjaj_id = 'zn341ef299';
...
SET @operater_kodoperatera = 'ey300qm253';
SET @operater_ime = 'SRĐA IKOVIĆ';
SET @operater_korisnicko_ime = 'srdja';
SET @operater_lozinka = '$pbkdf2-sha256$29000$BsC4V6o1prT2fu/9X2ttjQ$63V.4r1x44KZyBmn5bKJEuSV/X83CCv0tYuP7n/PqvI';
