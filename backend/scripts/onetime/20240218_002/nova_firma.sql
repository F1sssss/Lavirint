...
SET @firma_pib = '03270017';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ELITE ORGANIK"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VILA DANICA B.B. MARIĆI';
...
SET @firma_cert_pass = 'gAAAAABl0kVsGAXgre8F64lxImTozESm8MIrhQ8mfUUj0Hogwha8c2vFrrMReYvCEWenjfyyj0AuUMlRuZRmFHaLI7upScQbug==';
...
SET @organizaciona_jedinica_efi_kod = 'jg778au130';
...
SET @naplatni_uredjaj_id = 'ns089nd469';
...
SET @operater_kodoperatera = 'ts439qk941';
SET @operater_ime = 'BILJANA COLIC';
SET @operater_korisnicko_ime = 'biljana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$2BujNAYAQMg5R8g5R2htTQ$ZKXFWK3hkVM9yMQhfv5BLtFBq6vEurKTsgpVYzbqFxs';
