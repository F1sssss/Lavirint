...
SET @firma_pib = '03216012';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "YK BEAUTY BAR"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BLAŽA JOVANOVIĆA BB';
...
SET @organizaciona_jedinica_efi_kod = 'kd987hp911';
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje naplatnog uređaja 1

SET @naplatni_uredjaj_id = 'cg521lt541';
...
SET @operater_kodoperatera = 'vl434bb910';
SET @operater_ime = 'MARGARITA ZUBCHENKO';
SET @operater_korisnicko_ime = 'margarita2';
SET @operater_lozinka = '$pbkdf2-sha256$29000$PgegNKY0xhjjvDdmLKUU4g$RSVtVYfQ.b8ewH8VL0MGvb.fQYoG4Qiac.F6qvai40k';
...
SET @operater_kodoperatera = 'eh490ft781';
SET @operater_ime = 'YULIA KNEZEVICH';
SET @operater_korisnicko_ime = 'yulia2';
SET @operater_lozinka = '$pbkdf2-sha256$29000$17qXkhIiJIQwpjSmFOJ8jw$JnAiRX3qxk0anzST5l4OVir76NIa77HuborBhhs1PkU';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
