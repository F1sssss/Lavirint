...
SET @firma_pib = '03622746';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "KAJEVIĆ GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'KULINA 48';
...
SET @firma_cert_pass = 'gAAAAABltL9fgWO0vlsdYQjDZlXCbphQk3XLjBVajGzcxSJxY_ua8mP8PW8O3WtfKWemrXviLcfXvVsWj0Ty0AXG3p9h6ovb-w==';
...
SET @organizaciona_jedinica_efi_kod = 'am502ku838';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'KULINSKA 48';
...
SET @naplatni_uredjaj_id = 'iq280fr451';
...
SET @operater_kodoperatera = 'mf094qc852';
SET @operater_ime = 'SANI KAJEVIC';
SET @operater_korisnicko_ime = 'sani';
SET @operater_lozinka = '$pbkdf2-sha256$29000$1RpDaG0NIYRQyrn3HqOUsg$iqzQrQVt4WgehAimEylG.c36NMl.v8dSHLHl1g/FqKc';
