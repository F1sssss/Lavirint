...
SET @firma_pib = '03414680';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "ZEBRA SOLUTIONS"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABk-CPkr77gGHPkHA1Wwruc8vezRi5QScpbRKyNF2Lizk6rPn7ksQ2Vegd3JS5kQKLAv5HhkwMmSUV3rEjXYJvsLoLWlg==';
...
SET @organizaciona_jedinica_efi_kod = 'tf041ba312';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'PALIH BORACA, ULAZ 22A, STAN 27';
...
SET @naplatni_uredjaj_id = 'yb931sa649';
...
SET @operater_kodoperatera = 'tf936gx773';
