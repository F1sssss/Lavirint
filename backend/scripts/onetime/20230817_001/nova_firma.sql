...
SET @firma_pib = '03562581';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "FLOWMAX"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '	MURTEZIRA KARAĐUZOVIĆA 28';
...
SET @firma_cert_pass = 'gAAAAABk3fZviwvLMWNgt0kErKFuiWpXPo-gLf6vBa0Jn4h3CLyL7G6Pzn7ElKNEzqL1NasKSJXCAyTWTC-NZHqyVyDHFPJkrg==';
...
SET @organizaciona_jedinica_efi_kod = 'ha426lx706';
SET @organizaciona_jedinica_naziv = 'UPRAVA';
SET @organizaciona_jedinica_adresa = 'MURTEZIRA KARAĐUZOVIĆA 28';
...
SET @naplatni_uredjaj_id = 'tf227oe097';
...
SET @operater_kodoperatera = 'fe389pg028';
SET @operater_ime = 'MILAN RAIČEVIĆ';
SET @operater_korisnicko_ime = 'milan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$o1TqvZdSilEqhZDyfi.FMA$azkGDt8yo3oRaFWjS3bLulDCdgPYPmAt8YsKbdt52YA';
