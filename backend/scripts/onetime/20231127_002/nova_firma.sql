...
SET @firma_pib = '03609880';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ABM SMART SYSTEMS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BAČIĆA BR. 1, LATVA GRBALJSKA';
...
SET @firma_cert_pass = 'gAAAAABlZMlRbCQRZwPXxFxyMt7EhQ9prQZgM-MFqHqRPtb3-u8tXbkCDg1kJ4A76Up_XQiEk76-Yf_vLE29xzJsp9ZRHabK1Q==';
...
SET @organizaciona_jedinica_efi_kod = 'oi379wd764';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BAČIĆA BR. 1, LATVA GRBALJSKA';
...
SET @naplatni_uredjaj_id = 'jw324gs396';
...
SET @operater_kodoperatera = 'mv746ll131';
SET @operater_ime = 'MARKO MARAŠ';
SET @operater_korisnicko_ime = 'marko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$hNDae895z5nznrPWOidkrA$7rgpt9H4Vq0NaptY6scyITTfCr/Ijqw0vjjfvaDIIIo';
