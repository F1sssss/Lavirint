...
SET @firma_pib = '03594947';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "POLAKO BEAUTY 3"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NOVOSADSKA 18';
...
SET @firma_cert_pass = 'gAAAAABk_vmgm-8bwxz8i9nOgwisriXxaxwFZemQQel20vedAQqtmILc2kV_qViSaPsiVlmI3lhqGGVEMk5cbCGTkTjfv0iIOw==';
...
SET @organizaciona_jedinica_efi_kod = 'gh385hq032';
...
SET @naplatni_uredjaj_id = 'gm502aa461';
...
SET @operater_kodoperatera = 'br287rr036';
SET @operater_ime = 'VIKTIIA NISTOR';
SET @operater_korisnicko_ime = 'viktiia';
SET @operater_lozinka = '$pbkdf2-sha256$29000$31sLYYxRijHGGKPUujdGqA$H6KtSJLwNVeDfJRQ6env8xLAHlmgMKIUUAl2hs0ETUs';
