...
SET @firma_pib = '03628639';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "GLIGORIJE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '29. NOVEMBRA BB';
...
SET @firma_cert_pass = 'gAAAAABl1pHM18UuDU9XqGsaAn2tEdOzwT-PD1jds8FFb8h44gl5C4NvT2mOv7v6Nf8rKv8XAiadYe_IMFdPTJFMzuuW-RlO7g==';
...
SET @organizaciona_jedinica_efi_kod = 'fs691tr030';
...
SET @naplatni_uredjaj_id = 'ug557yb324';
...
SET @operater_kodoperatera = 'gh122xq256';
SET @operater_ime = 'IGOR VUKOVIC';
SET @operater_korisnicko_ime = 'igor';
SET @operater_lozinka = '$pbkdf2-sha256$29000$iLG2du4d43zv3RvD.N/7nw$MQ8ts46Gwj72BwenUkjEzSpxfQ9gOYW8CNqEou6vg2M';
