...
SET @firma_pib = '2710992270017';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'RISTO SINĐIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PEŠCA BB';
...
SET @firma_cert_pass = 'gAAAAABlN2oi1_HxymF3eOiGvdjTAnpiYf7Eq9tkWLaTHoudJSuJO9Ei6mbEk8YqRUI1oYO4VHiREXa2u5mGmi0EBl7_1GG-8w==';
...
SET @organizaciona_jedinica_efi_kod = 'jt460uh267';
SET @organizaciona_jedinica_naziv = 'LJUPKINA KUHINJA';
SET @organizaciona_jedinica_adresa = 'PEŠCA BB';
...
SET @naplatni_uredjaj_id = 'lb809ve308';
...
SET @operater_kodoperatera = 'dq288ls697';
SET @operater_ime = 'RISTO SINĐIĆ';
SET @operater_korisnicko_ime = 'risto';
SET @operater_lozinka = '$pbkdf2-sha256$29000$J0TImTPGeM/5HyNEKIWwFg$vGQgBXhBekEvEXPAztC2MJWqWgLifyTyciOHGYnlop4';
