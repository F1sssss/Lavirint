...
SET @firma_pib = '03001326';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "MACCHIATO CO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'UL. STUDENTSKA LAMELA BR. 2-4';
...
SET @organizaciona_jedinica_efi_kod = 'uy930jz616';
SET @organizaciona_jedinica_naziv = 'INFINITY AROMA';
SET @organizaciona_jedinica_adresa = 'STUDENTSKA 2-4';
...
SET @naplatni_uredjaj_id = 'el566bt692';
...
SET @operater_kodoperatera = 'yf029uf816';
SET @operater_ime = 'SRĐAN KALUĐEROVIĆ';
SET @operater_korisnicko_ime = 'srdjan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$4VzrvReCEAJgjHHOOafUmg$5Gg074UY2GY6gEJ9SFqNqFviV1B/QqAjfM04FLFoPoM';
