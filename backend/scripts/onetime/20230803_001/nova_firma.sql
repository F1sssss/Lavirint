...
SET @firma_pib = '1407955710432';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'MILOSAV LUTOVAC';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'SELO DAPSIĆE';
...
SET @firma_cert_pass = 'gAAAAABky1aPnoEShjl5w3gsir_bPFE10rKOgLOD5NLxvq_w7cs__d2PDwd9MLPcoxMUkWJ07Wtd1j3zJl3enyOv8FXTmnDaGw==';
...
SET @organizaciona_jedinica_efi_kod = 'yx817ih630';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'DAPSIĆE BB';
...
SET @naplatni_uredjaj_id = 'up236ao518';
...
SET @operater_kodoperatera = 'cg240eh388';
SET @operater_ime = 'MILOSAV LUTOVAC';
SET @operater_korisnicko_ime = 'milosav';
SET @operater_lozinka = '$pbkdf2-sha256$29000$b.0do1TKuTdmDKG0FiJkTA$YpQ6jryDXXWkzzJbdz1F/Bnf513.HG2QAfrXADHx5Uo';
