...
SET @firma_pib = '03323633';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "CONSULT MILE ST"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ZMAJ JOVINA 36';
...
SET @organizaciona_jedinica_efi_kod = 'bs512gr282';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'ZMAJ JOVINA 36';
...
SET @naplatni_uredjaj_id = 'ua387go218';
...
SET @operater_kodoperatera = 'aa438ss351';
SET @operater_ime = 'ŽARKO OSTOJIĆ';
SET @operater_korisnicko_ime = 'zarko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$t1bK2RtjDMG4FyIEYGxNCQ$yA/JwkTP59d2qz52hH258yZezIIxEnCa.na5ElSKbPs';
