...
SET @firma_pib = '02730740';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "MOBI-SAN"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RIFATA BURĐEVIĆA BB';
...
SET @organizaciona_jedinica_efi_kod = 'ux973mp967';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BANDŽOVO BRDO II BB';
...
SET @naplatni_uredjaj_id = 'nl372hd597';
...
SET @operater_kodoperatera = 'mf658kr258';
SET @operater_ime = 'MUSTAFA HOĐŽIĆ';
SET @operater_korisnicko_ime = 'mustafa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$RsiZEwKAsLbWuhfCWKtVag$rzqoH3aPvt.nvSoTGwi/uTS/vPdvcuzYemsfNHS0E1o';
