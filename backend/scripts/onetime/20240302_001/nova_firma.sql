...
SET @firma_pib = '1506982272038';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'ENES NOKIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'SUHOPOLJSKA';
...
SET @firma_cert_pass = 'gAAAAABl4uRNSMko_zAQ1ZpXgq_tcAKooYPgNiqhLhLRP3f9vSwd0fhxrqhMB1dS_vM3dqzIWmgp1eLDyx1pUe5qctuCb4a-QA==';
...
SET @organizaciona_jedinica_efi_kod = 'nn027yd323';
SET @organizaciona_jedinica_naziv = 'SZR"ELEGANT"';
SET @organizaciona_jedinica_adresa = 'SUHO POLJE BB';
...
SET @naplatni_uredjaj_id = 'vl935my896';
...
SET @operater_kodoperatera = 'ih610qw439';
SET @operater_ime = 'ENES NOKIĆ';
SET @operater_korisnicko_ime = 'enes';
SET @operater_lozinka = '$pbkdf2-sha256$29000$7P1fyxkD4JwTwpgzxrh3bg$m.yXcXGHNBcf9fwzuodafvHxYhlWqVxwm8qFvnaFyQ0';
