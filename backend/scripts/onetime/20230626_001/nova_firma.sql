...
SET @firma_pib = '2207005291519';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'ADVAN ZULIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILA PERUNIČIĆA BB';
...
SET @firma_cert_pass = 'gAAAAABkmPrvZo1gE8QNFFu6vB2pYK186tilnReRHW8N1om1s5sz6fwe8TrsFEKIxSxILXvDf5nQDWkTWBHvdsNQsIb-aduDig==';
...
SET @organizaciona_jedinica_efi_kod = 'ae839ai926';
SET @organizaciona_jedinica_adresa = 'TRG 13.JULA BB';
SET @organizaciona_jedinica_grad = 'PLJEVLJA';
SET @organizaciona_jedinica_drzava = 39;
SET @organizaciona_jedinica_naziv = 'RENT-A-CAR ZA DJECU';
...
SET @naplatni_uredjaj_id = 'nc579uh628';
...
SET @operater_kodoperatera = 'cb296zm146';
SET @operater_ime = 'ADVAN ZULIĆ';
SET @operater_korisnicko_ime = 'advan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$ViqF0BrjvBei9B5DSGkNgQ$Flm7J96V7p3kZ9NaA5A6grdiRu2BATH63sqJIDGuWWQ';
