...
SET @firma_pib = '03621251';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "DEJANOVIĆ DETAILS"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlpqxRdoM7LhALqDkKOmgL5qSt9X7LuRkTipzSkmChPUm_v_pID39C5DrfUBcr2kic84zjMoJGO8oMaCIa4Dk178VjSg==';
...
SET @organizaciona_jedinica_efi_kod = 'ob992kv187';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BULEVAR SVETOG PETRA CETINJSKOG 65';
...
SET @naplatni_uredjaj_id = 'zl735mu733';
...
SET @operater_kodoperatera = 'zt679at575';
SET @operater_ime = 'DEJAN DEJANOVIĆ';
SET @operater_korisnicko_ime = 'dejan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$Y.ydM8Y4h1BKSQmhtNYaAw$ydYZFkiKBvF6Vx4PgSnUfHX5OKQ0O/YzfFtcB4.bV.w';
