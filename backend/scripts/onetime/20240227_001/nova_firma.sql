...
SET @firma_pib = '03183700';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "S&N INVEST"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BIOČE BB';
...
SET @firma_cert_pass = 'gAAAAABl3iNSK1f5usmIHqE9c-83mdRVgU01PtoWdi7NnOfjPzUYHUxE4LBT9Ug1R0ehOpHL4U5weuAKnREHnB9cV4V_7pWLfQ==';
...
SET @organizaciona_jedinica_efi_kod = 've478nw529';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BIOČE BB';
...
SET @naplatni_uredjaj_id = 'gp725sg576';
...
SET @operater_kodoperatera = 'cu698jw643';
SET @operater_ime = 'Siniša Novaković';
SET @operater_korisnicko_ime = 'sinisa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$5xyjlDIGoPQe47z3vjfGeA$ROP.qkg0omMFQj4YrxXPq7V3vLtr33IS8KwgTvEU.Xg';
...
SET @operater_kodoperatera = 'on932hq180';
SET @operater_ime = 'Saša Novaković';
SET @operater_korisnicko_ime = 'sasa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$ZMy5l7LW.h.j9P7/H.PcWw$l7m/foV3nRD53lb0pa2Lz7rGl8HFjNJ7tci5pOaZr9A';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
