...
SET @firma_pib = '03404617';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "FULL MONTY YACHT CHARTER"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BOGUNOVO 16';
...
SET @firma_cert_pass = 'gAAAAABlV0D4zquyYKeuwRZ6c8e6hhNHhwHfF6DyADLRYLqxN6UoB3_GO7GaJprRVzDfI58DZAhFJCBddkpRy-ZcBHwptrW23A==';
...
SET @organizaciona_jedinica_efi_kod = 'dv742bj829';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BOGUNOVO 16';
...
SET @naplatni_uredjaj_id = 'ah920mx571';
...
SET @operater_kodoperatera = 'uw729ay927';
SET @operater_ime = 'Olivera Todorovic';
SET @operater_korisnicko_ime = 'olivera';
SET @operater_lozinka = '$pbkdf2-sha256$29000$dc6ZM2asNebcG4NQCiEE4A$ptOeA4GzHOnmRSWQY0w7.pooJOCnw8zLZb2pXCTVD7w';
