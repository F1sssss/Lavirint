...
SET @firma_pib = '03579433';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "EMILY RENT A CAR"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'KUKULJINA BB';
...
SET @firma_cert_pass = 'gAAAAABk6GIAnL9Cfank8NuUv3BggzeWKudeoJ4Dr01amcu7H3LeT_kFAmMbKAO7a208x0mfsNMdS7z7VERg4HzgFd2jyHu2uQ==';
...
SET @organizaciona_jedinica_efi_kod = 'wi028ib557';
SET @organizaciona_jedinica_naziv = 'EMILY RENT A CAR';
SET @organizaciona_jedinica_adresa = 'KUKULJINA 16';
...
SET @naplatni_uredjaj_id = 'ou726tx872';
...
SET @operater_kodoperatera = 'ny028bb750';
SET @operater_ime = 'TAMARA RADONIC MIJOVIC';
SET @operater_korisnicko_ime = 'tamara';
SET @operater_lozinka = '$pbkdf2-sha256$29000$bU0JoRRiLIWQ8j5HqHWuVQ$uuXNHu4QQvYqCn24/Fb0uXHeSmu8fYCgyg3pDQwhYH4';
