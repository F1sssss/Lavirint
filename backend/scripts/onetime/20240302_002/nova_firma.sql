...
SET @firma_pib = '3005985225012';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'VALJDETE CUKOVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RASTIŠ BB';
...
SET @firma_cert_pass = 'gAAAAABl4uXm1nZaFa_qAIUVJqVELM7ad_8nGPUuoN1nqKpNPZ4xJm5Cc9JtNQxyZTAtx5SDcX8awxw686vQQxny6EjOrREl1w==';
...
SET @organizaciona_jedinica_efi_kod = 'qo044ad876';
SET @organizaciona_jedinica_naziv = 'STR "DINI & DINA"';
SET @organizaciona_jedinica_adresa = 'PRISTAN BB';
...
SET @naplatni_uredjaj_id = 'rp161sx808';
...
SET @operater_kodoperatera = 'gf481lm505';
SET @operater_ime = 'VELJDETE CUKOVIĆ';
SET @operater_korisnicko_ime = 'valjdete';
SET @operater_lozinka = '$pbkdf2-sha256$29000$yFkLYSyFEILw3junlDJmzA$Z2BJiY3.LtwdOmh9ZIT/fXJYBPNYWOJzqv.FY7OsPZE';
