...
SET @firma_pib = '02904462';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "EURO ZARA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TALUM BB';
...
SET @firma_cert_pass = 'gAAAAABlzbMi3QDgHlgh1RtuuYEBqETQ9blPNsSd451qGwhqWDMLnG_I8nWjz948oPdd9mEuLgaDmqziJAOmwlxRUPRUeA58Hg==';
...
SET @organizaciona_jedinica_efi_kod = 'vg423tl281';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'TALUMSKA BB';
...
SET @naplatni_uredjaj_id = 'xl462dw183';
...
SET @operater_kodoperatera = 'rb401ij159';
SET @operater_ime = 'ADNAN ADROVIC';
SET @operater_korisnicko_ime = 'adnan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$m7PW.v8/h1CqtRZCCIEwRg$YLVyAgdopk.iI63Yl.FUV0M/nfwrj.2EF9pcZH.T2WA';
