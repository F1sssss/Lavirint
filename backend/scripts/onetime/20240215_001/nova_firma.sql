...
SET @firma_pib = '03049817';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "2LB MONTENEGRO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '4 JUL 56A/45';
...
SET @firma_cert_pass = 'gAAAAABlzbDdRB6GEzwKUvfUdHpx5WEtTKTnBQffXhnX7wJZeTTQkRrskBlZZLipn8uXNWBwD_nhzjr8M1sl6PSejGfOYh2uTQ==';
...
SET @organizaciona_jedinica_efi_kod = 'ww519ms608';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = '4.JULA 56A';
...
SET @naplatni_uredjaj_id = 'fi418qm644';
...
SET @operater_kodoperatera = 'md494hp991';
SET @operater_ime = 'Bojana Saranovic';
SET @operater_korisnicko_ime = 'bojana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$3ptTSql1jvH.P0dIifFeyw$Dh.x2KGP9ix7AKCZJZowl0J1oSRcAUS5pU2ADjOXMdA';
