...
SET @firma_pib = '03641066';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "ALLEGRA PLUS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MLINARSKA BR. 23, BIJELA';
...
SET @organizaciona_jedinica_efi_kod = 'ka459jf269';
SET @organizaciona_jedinica_naziv = 'Rent a car';
SET @organizaciona_jedinica_adresa = 'MLINARSKA 23';
...
SET @naplatni_uredjaj_id = 'zm726tg473';
...
SET @operater_kodoperatera = 'vf565ff500';
SET @operater_ime = 'Djordje Vucetic';
SET @operater_korisnicko_ime = 'djordje';
SET @operater_lozinka = '$pbkdf2-sha256$29000$wdh7r/V.790757zXGsO4Fw$kWCTaJPM8iLGYEJ5q.vL3vwq1IErRw6kKneVeStHBoo';
