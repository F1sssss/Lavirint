...
SET @firma_pib = '02865912';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "EURO IZGRADNJA LIČINA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RADMANCI';
...
SET @firma_cert_pass = 'gAAAAABk3vY-9eDP9DjKEBwu590YpiiWWYF1Xquey2_pU6HvZkv4jNVlp84eV3xE_6RhcXhu7PVVQUHE-lySzdO8tqrw0uETYw==';
...
SET @organizaciona_jedinica_efi_kod = 'gg247qs922';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'RADMANCI BB';
...
SET @naplatni_uredjaj_id = 'ou988fk342';
...
SET @operater_kodoperatera = 'vt589xl784';
SET @operater_ime = 'FEKO LIČINA';
SET @operater_korisnicko_ime = 'feko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$jJHSujfmfE/JGUNIqRXCuA$mm4/k2s0qsygNMJG.fhyhnIRSuhZMx3.VeOxpt7pmRg';
