...
SET @firma_pib = '03546756';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "M.B. AXA BRIDGE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ZATON BR. 186';
...
SET @firma_cert_pass = 'gAAAAABk3vnKjq3SxUW3_UO2UAeKCeS-KBOoFJkQF2ExrDWHM5i2EoQ9NJpk2JvNoRnhOXz9_1CHR5dcF2GgaOUe7fkzInDbiQ==';
...
SET @organizaciona_jedinica_efi_kod = 'vn628ip727';
...
SET @naplatni_uredjaj_id = 'un788up997';
...
SET @operater_kodoperatera = 'dn565vh085';
SET @operater_ime = 'MERIS BRUNCEVIC';
SET @operater_korisnicko_ime = 'meris';
SET @operater_lozinka = '$pbkdf2-sha256$29000$ZAyhNMb4H8N4L0UoxVirFQ$KBObxuR1jFFJ0FJAhQFHpF6V0HVVadve/GT.VsFeQl0';
