...
SET @firma_pib = '1312004220507';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "JON JAKUPI"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MEHMET GJYLI 123';
...
SET @organizaciona_jedinica_efi_kod = 'zo760om899';
SET @organizaciona_jedinica_naziv = '"SKIN CARE CENTER BY B"';
SET @organizaciona_jedinica_adresa = 'BULEVAR TEUTA 100';
...
SET @naplatni_uredjaj_id = 'tc149dl419';
...
SET @operater_kodoperatera = 'sb536lg326';
SET @operater_ime = 'JON JAKUPI';
SET @operater_korisnicko_ime = 'jon';
SET @operater_lozinka = '$pbkdf2-sha256$29000$mFPqHeOcU.odA0DIWYsR4g$N37EHPTPQh9J8IYAIBPUS1I9CWceQs7aTMQtaaN0Cbs';
