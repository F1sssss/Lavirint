...
SET @firma_pib = '03181855';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "AMER-ARMEN"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RASOVO B.B.';
...
SET @firma_cert_pass = 'gAAAAABk3vgQ8o3xdh2pWwxABHthqk6lgkxLrlvxiuqKeDLTOUVTgzj2FDbbwcOSXXCIVX_fy9g34stAbfWYYHwdxKixobORew==';
...
SET @organizaciona_jedinica_efi_kod = 'tq016ia771';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'RASOVO BB';
...
SET @naplatni_uredjaj_id = 'vm231ud195';
...
SET @operater_kodoperatera = 'pd019ba913';
SET @operater_ime = 'EDIS ZEJNILOVIĆ';
SET @operater_korisnicko_ime = 'edis';
SET @operater_lozinka = '$pbkdf2-sha256$29000$fe.9t7Y2BsAY4/wfA0BorQ$yL0T01M4AT9S2hXEp66BJlOntDduzn99vwGJIXbugMA';
