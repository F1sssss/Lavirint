...
SET @firma_pib = '03496155';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = '"DOBRO TP" D.O.O.';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABkrmpf0cIxMfjafEcFjhJOvZ9pZLvQu4UIUnofyJPNMDonTcC-9i9NgCU4GvpbuuOKBuGAyBu6Uvq_knJcJqORhiWDTA==';
...
SET @organizaciona_jedinica_efi_kod = 'em014of831';
SET @organizaciona_jedinica_adresa = 'TRG SUNCA 2';
...
SET @naplatni_uredjaj_id = 'on941di095';
...
SET @operater_kodoperatera = 'uh010km205';
SET @operater_ime = 'TIMOFEI PENKOV';
SET @operater_korisnicko_ime = 'timofei';
SET @operater_lozinka = '$pbkdf2-sha256$29000$lzKmNKZUas3Z.58zxjhH6A$rATJjiJxnrB7vyuKgqA0cOjmPjHYcljJx.qBEPSz9Kk';
