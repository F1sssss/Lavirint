...
SET @firma_pib = '03408221';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "BOLD" ROŽAJE';
SET @firma_pdvbroj = '';
SET @firma_adresa = '30 SEPTEMBAR BB';
...
SET @organizaciona_jedinica_efi_kod = 'ju475iv724';
SET @organizaciona_jedinica_naziv = 'BUTIK BOLD 1';
SET @organizaciona_jedinica_adresa = '30.SEPTEMBAR BB';
...
SET @naplatni_uredjaj_id = 'nf447gk740';
...
UPDATE operater SET firma_id=@firma_id, naplatni_uredjaj_id=@naplatni_uredjaj_id, magacin_id=@magacin_id WHERE id=2017;