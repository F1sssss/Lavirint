SET @magacin_id = 1009;
SET @naplatni_uredjaj_id = 1027;
SET @firma_id = 968;

------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera 1

SET @operater_kodoperatera = 'nn443tx060';
SET @operater_ime = 'Medina Ademagić';
SET @operater_korisnicko_ime = 'medina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$AoCwthZCiJFyztl7r7XWug$iIKwY4SBFZwxK4jxSR5yanuUT3W6HDloyhixayH3omI';
