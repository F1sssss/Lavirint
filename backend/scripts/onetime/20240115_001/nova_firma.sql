...
SET @firma_pib = '03349985';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "VOVA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA BR.48';
...
SET @firma_cert_pass = 'gAAAAABlpRAx7vk7Ocx63UfFs66QScDUcoWPyKYak9fhogwoH2aP2qwSyNdkoXHEKq26XkDHDJ1Je40oh9xtpA0R_uBJIaaolA==';
...
SET @organizaciona_jedinica_efi_kod = 'rb931fn096';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA 48';
...
SET @naplatni_uredjaj_id = 'bz396di720';
...
SET @operater_kodoperatera = 'rq228at466';
SET @operater_ime = 'Dmitry Sapozhnikov';
SET @operater_korisnicko_ime = 'dmitry';
SET @operater_lozinka = '$pbkdf2-sha256$29000$J4SQklKqVYqxFiLEeE8phQ$M/azzF7.o2STuFxBHJ/6r/GyU8LbLk93dHpJdBDcTnw';
