...
SET @firma_pib = '3005998278018';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "AMRA MUJEVIĆ"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PAUČINA BB';
...
SET @firma_cert_pass = 'gAAAAABlf_MXCMHYh3nsELFOpeGcvmdp1552D9kPOslI-FPO8-VRmt_L1KdgJV9-aHd8qMpgq2yU6cT0lsATehcVKp3uhnz_6g==';
...
SET @organizaciona_jedinica_efi_kod = 'ue952dx958';
SET @organizaciona_jedinica_naziv = 'STR "BUTIK AMRA"';
...
SET @naplatni_uredjaj_id = 'kc888lz687';
...
SET @operater_kodoperatera = 'xn448xq170';
SET @operater_ime = 'AMRA MUJEVIĆ';
SET @operater_korisnicko_ime = 'amra';
SET @operater_lozinka = '$pbkdf2-sha256$29000$Z6z1nnPOOSckxLh3DoHwHg$MFGAWzOuYvy5hldCNNgh4iOT0JYIc9nIzSead7oQ0ro';
