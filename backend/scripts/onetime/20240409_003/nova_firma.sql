...
SET @firma_pib = '03617459';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "TMR GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NASELJE SVETE PETKE BB';
...
SET @organizaciona_jedinica_efi_kod = 'ea312vy205';
...
SET @naplatni_uredjaj_id = 'zw069sy719';
...
SET @operater_kodoperatera = 'tr432qt426';
SET @operater_ime = 'MEHMET NURI TIMUR';
SET @operater_korisnicko_ime = 'mehmet';
SET @operater_lozinka = '$pbkdf2-sha256$29000$4TwHwFhr7d3buzdGaO2dUw$1.nzQlrV89sSRWVIHwr5AwXyxPFyTSeH67raMAdQpkM';
