...
SET @firma_pib = '03588556';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "LA PERLA INTIMO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILOŠA MALIŠIĆA BR. 6';
...
SET @firma_cert_pass = 'gAAAAABk8Wvca2i3qtTNmkpeQk_duAs-Jzb889ocEfjyPIHXUNbsGb8WyvwkGSgyvjzTSuxtOAjFrgo2oQCmqIjxx3LldabURw==';
...
SET @organizaciona_jedinica_efi_kod = 'bq874ef160';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MILOŠA MALIŠIĆA 6';
...
SET @naplatni_uredjaj_id = 'ev147aq444';
...
SET @operater_kodoperatera = 'dx488cw862';
SET @operater_ime = 'MARINA RAČIĆ';
SET @operater_korisnicko_ime = 'marina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xZizNkYIASDEeM.51zrnnA$PUSG0zh1fG9qNqW6wxF6N1zFB1nmsrzIOC8/4.yHMis';
