...
SET @firma_pib = '02880245';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ELBO - HERCEG NOVI"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA BR. 87A';
...
SET @firma_cert_pass = 'gAAAAABk8WjHsDz55NgO2pofqRwJqp_TrubdEEbPBji6yuU6LPHxEeuO8R5Pn9rZRoY9o7kWkFNhFfhz6fdz2_ZpgvfgrsC_FQ==';
...
SET @organizaciona_jedinica_efi_kod = 'fu176dd270';
...
SET @naplatni_uredjaj_id = 'hk915sa349';
...
SET @operater_kodoperatera = 'sl006kf571';
SET @operater_ime = 'Slobodan Jeremić';
SET @operater_korisnicko_ime = 'slobodan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xxjj/L.Xcu597723dg6BsA$UB5fsTubxJnExiDWE/fycLXHtsObf6/06avSW5W9UUY';
