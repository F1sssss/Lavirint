...
SET @firma_pib = '03643077';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "MONTENEGRO CONSULTING 1"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TRG SUNCA BR. 4';
...
SET @organizaciona_jedinica_efi_kod = 'jw418bw250';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'TRG SUNCA 4';
...
SET @naplatni_uredjaj_id = 'zx471ut453';
...
SET @operater_kodoperatera = 'om853lb181';
SET @operater_ime = 'DANIJELA GRAHOVAC';
SET @operater_korisnicko_ime = 'danijela';
SET @operater_lozinka = '$pbkdf2-sha256$29000$.r.3FkKIsRZijNF67907xw$i/BQwh3AHlevRyOQ2yJ.hDNSBssYok8c1F4MAVuZPAw';
