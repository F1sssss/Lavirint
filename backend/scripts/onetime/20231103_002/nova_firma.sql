...
SET @firma_pib = '0603998275020';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'ROSA BARJAKTAROVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PETNJIK BB';
...
SET @firma_cert_pass = 'gAAAAABlRSCP57z-XZoUlNkNkJqVO0l00bO3cIYnhuWXoqAlpGHbywMfTmq_KDkCJRMEHexquiaBuz7M7IcDh3IZkSk77alZaw==';
...
SET @organizaciona_jedinica_efi_kod = 'xy026cc268';
SET @organizaciona_jedinica_naziv = 'STR TRGOVINA ROSA';
SET @organizaciona_jedinica_adresa = 'JASIKOVAČKA BB';
...
SET @naplatni_uredjaj_id = 'dd320xb765';
...
SET @operater_kodoperatera = 'cv247db315';
SET @operater_ime = 'ROSA BARJAKTAROVIĆ';
SET @operater_korisnicko_ime = 'rosa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$2Psfw1hLKaW0VqpV6t37/w$omEs.ugeTlQIj8IZcXxbwaX1rtAY.Zsda1hHu2jxZQE';
