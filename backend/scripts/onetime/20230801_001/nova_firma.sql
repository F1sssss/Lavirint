...
SET @firma_pib = '03390993';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "CJ ELECTRICAL"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TRG BOŽANE VUČINIĆA 10/1';
...
SET @firma_cert_pass = 'gAAAAABkyLfvOcrKj71dtr0b98PtMaCiZVcnPgJXIig0kS3zEzRGFaH-bw7hTli6IsaKbx8tM8EB_tPnNx489Lv1CdGWkP5J2g==';
...
SET @organizaciona_jedinica_efi_kod = 'mu462os735';
SET @organizaciona_jedinica_naziv = 'CJ ELECTRONIK';
SET @organizaciona_jedinica_adresa = 'TRG BOŽANE VUČINIĆ 10/1';
...
SET @naplatni_uredjaj_id = 'jf254de935';
...
SET @operater_kodoperatera = 'xu718bb422';
SET @operater_ime = 'Biljana Colic';
SET @operater_korisnicko_ime = 'biljana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$2VvLGaNUas259x5jTOm9tw$ffC3B6Y6s3CT0DEbuA/OgmriL0kzhET.gMZJnuF4XEw';
