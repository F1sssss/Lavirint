...
SET @firma_pib = '03640612';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "NIL.COM"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PRVOG DECEMBRA BB';
...
SET @firma_cert_pass = 'gAAAAABl8ZV2xb_5GqJBgqEtNJmVrfhj9-4m1awFlmpfpebTH9aUuY1r4w59Y6uDapqXezgxyvW_4sUA76kHlUk_an3gxtaEgA==';
...
SET @organizaciona_jedinica_efi_kod = 'ql400gl062';
SET @organizaciona_jedinica_naziv = 'GOLD WASH';
SET @organizaciona_jedinica_adresa = '1.DECEMBRA BB';
...
SET @naplatni_uredjaj_id = 'ku785qc361';
...
SET @operater_kodoperatera = 'gw662or754';
SET @operater_ime = 'VLADAN SEKULIC';
