...
SET @magacin_id = 247;
SET @naplatni_uredjaj_id = 247;
SET @firma_id = 237;

------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operater

SET @operater_kodoperatera = 'xj372sj641';
SET @operater_ime = 'Balša Zejak';
SET @operater_korisnicko_ime = 'balsa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$vDdGSAnhHMP4H.Oc0zqHsA$sxaPG46PTxflrSOSuf6bXtSfzuFgSshCq0BstOwCanE';
