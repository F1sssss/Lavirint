...
SET @firma_pib = '03632008';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "SERVICE & PARTS HOT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RESNIČKA 33 BR. 2, RASOVO';
...
SET @firma_cert_pass = 'gAAAAABl1o7HK4aq9DxBhoo5B1_QWXOYhChYEzkN3dGz4DwH1mpKf120HuWd0DR-RRK8Fe1djWHjRKk3JhTNga_B617ZRlc65g==';
...
SET @organizaciona_jedinica_efi_kod = 'pt911wg232';
SET @organizaciona_jedinica_naziv = 'SERVICE & PARTS HOT';
SET @organizaciona_jedinica_adresa = 'RESNIČKA 33 BR. 2';
...
SET @naplatni_uredjaj_id = 'jh207uu459';
...
SET @operater_kodoperatera = 'ha404yv771';
SET @operater_ime = 'ALBIN HOT';
SET @operater_korisnicko_ime = 'albin';
SET @operater_lozinka = '$pbkdf2-sha256$29000$N4bQWquV8v7/n1Mqxfjf.w$kaHHTDlWBfHG9SY/qlLSEN9lPWMlQOK3.3zlpTVtUoM';
