...
SET @firma_pib = '03107175';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "PIRAMIDA SPORT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ŠAVNIČKA BR. 8';
...
SET @organizaciona_jedinica_efi_kod = 'of747ty875';
SET @organizaciona_jedinica_naziv = 'PIRAMIDA SPORT';
SET @organizaciona_jedinica_adresa = 'ŠAVNIČKA 8';
...
SET @naplatni_uredjaj_id = 'sx020bn984';
...
SET @operater_kodoperatera = 'bp513af049';
SET @operater_ime = 'RADENKO LONČAREVIĆ';
SET @operater_korisnicko_ime = 'radenko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$iDFGqFUqRQghxFiL8d5bKw$jG.v0ppUO5q7g.8yDJE4l.E.q1a9MvkQfIE8WKzRj1A';
