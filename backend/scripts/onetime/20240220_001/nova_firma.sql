...
SET @firma_pib = '03633187';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "M.B. INVEST CONSTRUCTION"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '19 DECEMBAR BR.5';
...
SET @firma_cert_pass = 'gAAAAABl1H22pY3J82hXIqGfh7v1vze3uXkTX7BsXh_ZJLXfdhdPEZdROCaM4praJSf73oC-2GTKWo8flGxuP0JiJrX9wFKRYw==';
...
SET @organizaciona_jedinica_efi_kod = 'pr441vp924';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = '19. DECEMBRA';
...
SET @naplatni_uredjaj_id = 'pr878ih212';
...
SET @operater_kodoperatera = 'dg827af559';
SET @operater_ime = 'ANJA BOJOVIC';
SET @operater_korisnicko_ime = 'anja';
SET @operater_lozinka = '$pbkdf2-sha256$29000$jhHifM.5VwqBsLb2XmuN8Q$EizJ5BhQlluwLuYjlrJ44sWjyAcKM76heIZ5IbHVKF4';
