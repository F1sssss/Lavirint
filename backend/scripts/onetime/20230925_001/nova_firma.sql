...
SET @firma_pib = '03583538';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "CREWMESS"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlEU0ZfInQWJ-MycJ_WSHdnKsxnvczyqPKps0Jj8zGDXWhurrWvPKP2Z7JEWktoAtkzWa_9_cd2b0OxrYVp7lEltGQwg==';
...
SET @organizaciona_jedinica_efi_kod = 'bf619nj925';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'TIVAT BB';
...
SET @naplatni_uredjaj_id = 'fx290ly286';
...
SET @operater_kodoperatera = 'pd158sy392';
SET @operater_ime = 'VIKTORIA VASKEVYCH';
SET @operater_korisnicko_ime = 'viktoria';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xliLkdI6ZyxF6D2HEGLs3Q$UJVyy.oS3WgejsVFZSDBPN35aZ.TBm.XuYB4IOv0CWk';
