...
SET @firma_pib = '03526364';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "WOOD&WIND GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILOŠA OBILIĆ 4';
...
SET @organizaciona_jedinica_efi_kod = 'jc366ov481';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MILOŠA OBILIĆA 4';
...
SET @naplatni_uredjaj_id = 'xw489oj180';
...
SET @operater_kodoperatera = 'tx408mq965';
SET @operater_ime = 'Nikolai Gorbenko';
SET @operater_korisnicko_ime = 'nikolai';
SET @operater_lozinka = '$pbkdf2-sha256$29000$0HrPWUtJqZVSKsV4r3VuDQ$Gd3alorZpEoY9lCrKU8VWxiGXAv2LYSUxXQkNe5LMsg';
