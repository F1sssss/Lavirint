...
SET @firma_pib = '03544087';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "BLESSING"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlGkfll7i7Wv_BmsKf03CFekiA5gUW4kpL78WlmYtbKkU4X4si-2198CWj2Tk9UNqVY-x5K6Ti8M3WRAoW3JngUe6IbA==';
...
SET @organizaciona_jedinica_efi_kod = 'ob736wo451';
...
SET @naplatni_uredjaj_id = 'wd509ww685';
...
SET @operater_kodoperatera = 'oy066fo157';
SET @operater_ime = 'BEHRAIM SEJFULA';
SET @operater_korisnicko_ime = 'behraim';
SET @operater_lozinka = '$pbkdf2-sha256$29000$lpLy/v///7.39h5DKMXY.w$BaprIFjNGfKCvKKD/Uc90W3hwnT/63qsqVxZPCtQY5o';
