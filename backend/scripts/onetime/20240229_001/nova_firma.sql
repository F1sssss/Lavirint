...
SET @firma_pib = '02421542';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "AUTOPREVOZ ZATON"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ZATON BB.';
...
SET @firma_cert_pass = 'gAAAAABl4Enf8uA7cTDtA6BtnmYLZy5eJ1O4-J50ljBYv642hTejSXDkqFphzQIR9cq7KWFOYDOj0_T4OXavXW5QZDBdVry3ww==';
...
SET @organizaciona_jedinica_efi_kod = 'pp223ym940';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'ZATON BB';
...
SET @naplatni_uredjaj_id = 'wg182xi524';
...
SET @operater_kodoperatera = 'qc637np998';
SET @operater_ime = 'Slobodan Jeremic';
SET @operater_korisnicko_ime = 'slobodan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$PGdM6X3PmdOa8/6/V4qRsg$22zb6qwgU8rdy.nk0ej16NnWtpcKkJwONRCJbCHLx48';
