...
SET @firma_pib = '03524230';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "STD"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlS0qWoaakO_-x2yY3Fd_1FXtAs5mpoxbEVe3OXvGlc419pX6422twZcr8ewx8jVffS4iqYiWrc_wPQ6AeaG_esOVhaQ==';
...
SET @organizaciona_jedinica_efi_kod = 'fv427in574';
...
SET @naplatni_uredjaj_id = 'lc228cb894';
...
SET @operater_kodoperatera = 'nm869nh636';
