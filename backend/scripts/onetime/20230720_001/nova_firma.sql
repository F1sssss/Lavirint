...
SET @firma_pib = '03560252';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = '"15.02" D.O.O.';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA BR. 136';
...
SET @firma_cert_pass = 'gAAAAABkuF_4ApskqvCaQvhkfdWRvHsaIL0-tK8SgJ8qxaAcF37ZQRzx7CQLLLm4VP53kzd6rAdmRqELOAXrECdHC-E8EUSffQ==';
...
SET @organizaciona_jedinica_efi_kod = 'rp871pz036';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'HERCEG NOVI BIJELA';
...
SET @naplatni_uredjaj_id = 'jr300dd878';
...
SET @operater_kodoperatera = 'qg207be437';
SET @operater_ime = 'RAUSHANIIA KHASANOVA';
SET @operater_korisnicko_ime = 'raushaniia';
SET @operater_lozinka = '$pbkdf2-sha256$29000$GUNIKUVIKaVUyjmndK6V0g$6Zlt84X2UogeQ8vccHn1T1LbRLftXyuwBHaRvDRi/eE';
