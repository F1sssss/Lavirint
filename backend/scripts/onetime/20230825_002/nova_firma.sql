...
SET @firma_pib = '03302474';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "LEDIO FASADA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILJANA VUKOVA 57';
...
SET @firma_cert_pass = 'gAAAAABk6GXH_aPRCxYk1SIbuw9x43kvWxfyu2W2y7N6v-wqHx7JgYA102n2CSOAZGGplnQd7Uon23RH_edQrRGXrnswqDcncg==';
...
SET @organizaciona_jedinica_efi_kod = 'cu712cp259';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MILJANA VUKOVA 57';
...
SET @naplatni_uredjaj_id = 'gq546oj433';
...
SET @operater_kodoperatera = 'wg552nr209';
SET @operater_ime = 'BILJANA JOKIĆ';
SET @operater_korisnicko_ime = 'biljana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$F0LofY.RMkYIofS.V2rN2Q$IFoErRC1UX6u/Uv/0CaNbsdgUXofvGeLHhrN97EHBuI';
