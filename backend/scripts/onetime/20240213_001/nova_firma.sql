...
SET @firma_pib = '0502969270132';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'TIHOMIR ĆERANIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VINICKA BB';
...
SET @firma_cert_pass = 'gAAAAABlyxNhhnVxJbxDig7lrWWbzBwo-vdl7rNY5dkUAuhqmp1dXWqqlUbt48ays3NDt0Et_q2H25dVMVxZmLdzX6S9GwJPEw==';
...
SET @organizaciona_jedinica_efi_kod = 'cc566ug637';
SET @organizaciona_jedinica_naziv = 'Frizerski salon "TIKA"';
SET @organizaciona_jedinica_adresa = 'IV CRNOGORSKE PROLETERSKE BRIGADE BB';
...
SET @naplatni_uredjaj_id = 'jb531xi555';
...
SET @operater_kodoperatera = 'gm590ow357';
SET @operater_ime = 'TIHOMIR ĆERANIĆ';
SET @operater_korisnicko_ime = 'tihomir';
SET @operater_lozinka = '$pbkdf2-sha256$29000$5Nw7J4RQam1tDWGM0fr//w$Zs0j8MppSoa27pxgj3jelLvdBX4.rZtDPetEFkA8ewo';
