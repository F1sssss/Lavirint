...
SET @firma_pib = '1604972234016';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "ŽELJKO KOVINIĆ"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RADOVIĆI BB';
...
SET @firma_cert_pass = 'gAAAAABlf_E504oS-zJUOPVpc29m1Y4RolIm2cSPkqtONloMwXsjpyMV1f79I7eVusALJ-gAKk5DJdJGQlTymJizC98SAPTRQw==';
...
SET @organizaciona_jedinica_efi_kod = 'kk912st008';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'RADOVIĆI BB';
...
SET @naplatni_uredjaj_id = 'be957yh888';
...
SET @operater_kodoperatera = 'jf548km810';
SET @operater_ime = 'ŽELJKO KOVINIC';
SET @operater_korisnicko_ime = 'zeljko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$nvMew7i3dm6Nca6VshZi7A$rblyJ8.rc0Cxiye6owLl40AIeI3.6mW9lDp3eYy8BPw';
