...
SET @firma_pib = '02967405';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "KARATAU"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA BR.8';
...
SET @firma_cert_pass = 'gAAAAABlHVihqQWgXqrmJeci0iZM8Iqx4cfqO9dqZVvmXXvkSXZRF_5M8_5XCji8wlzWBrRjHt8i9iirZSoCggJbejEf1XcUXQ==';
...
SET @organizaciona_jedinica_efi_kod = 're493gy542';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA BR.8';
...
SET @naplatni_uredjaj_id = 'hp255kd247';
...
SET @operater_kodoperatera = 'pb131sw174';
SET @operater_ime = 'INES CUK';
SET @operater_korisnicko_ime = 'ines';
SET @operater_lozinka = '$pbkdf2-sha256$29000$ifG.l7KWEqJUCmFsDcH4vw$TP/ImH2OfTya2m1jbsYN0X2t/NWdzeZ9lYnzqjv5T4Y';
...
SET @operater_kodoperatera = 'wo019ju172';
SET @operater_ime = 'MILENA JANICIC';
SET @operater_korisnicko_ime = 'milena';
SET @operater_lozinka = '$pbkdf2-sha256$29000$1ZozphTi3LtXitEa4xxjLA$NcK5tQlzKSNCNZRom.VzDWiDwzIAWPNdv8XNXK4G0Bs';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
