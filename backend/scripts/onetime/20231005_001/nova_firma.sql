...
SET @firma_pib = '03599485';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "MILIN BOŽUR"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '13 JUL BB';
...
SET @firma_cert_pass = 'gAAAAABlHq9lbr2y4rSmF_s1WrQWBYOmRtzvTFmRFSPiH1zNZyPWLWwlg7mSGFWpSXu2zkmjf7fomOFoK0FMvcICdQAojHXdiw==';
...
SET @organizaciona_jedinica_efi_kod = 'yd257bv025';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = '13 JULA BB';
...
SET @naplatni_uredjaj_id = 'pm222gt311';
...
SET @operater_kodoperatera = 'xh386ip757';
SET @operater_ime = 'Mihailo Aković';
SET @operater_korisnicko_ime = 'mihailo';
SET @operater_lozinka = '$pbkdf2-sha256$29000$3xvj/H.vNea89/7/v5cyJg$OmKGbAzigGoS5B0O4m4IW9vwxQLvRz0OEHZ5FEkKq0E';
