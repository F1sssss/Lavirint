...
SET @firma_pib = '02317575';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "PROGRES MV"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DOLAC BB';
...
SET @firma_cert_pass = 'gAAAAABl1pMwX3t83Zd3X3Xf14bJeLGkTf56y6eS__boiqEbqlCbejrBvLIFJQ3oK5PPAbb0njlb1YS3rHd3gmwkhXouDnXLxw==';
...
SET @organizaciona_jedinica_efi_kod = 'bx210zs273';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'DOLAC BB';
...
SET @naplatni_uredjaj_id = 'am613at934';
...
SET @operater_kodoperatera = 'ed915rl684';
SET @operater_ime = 'Vuceta Malisic';
SET @operater_korisnicko_ime = 'vuceta';
SET @operater_lozinka = '$pbkdf2-sha256$29000$Yyyl9H6vlVIq5dwbIyTkfA$txEBxb24bIv7k2vy.nCsMpC4nWJktETWivV4etbmBu8';
