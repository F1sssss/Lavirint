...
SET @firma_pib = '03604594';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "GREEN IDA MONTE"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABl9a1aW6hTTIfF77L2qYoO-A6Hr3D4T1ZJN_SNsMscXv7vPS8VAPPweOM21qgGGZPBaJxNWkao8qF-vvFu8q3AkzXiaQ==';
...
SET @organizaciona_jedinica_efi_kod = 'st470we357';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'PALIH BORACA 22A';
...
SET @naplatni_uredjaj_id = 'cg496rx783';
...
SET @operater_kodoperatera = 'pm187re373';
SET @operater_ime = 'ATAKAN CANKIRI';
SET @operater_korisnicko_ime = 'atakan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$4rz3njNGqPVeK.X83/u/Nw$Jhf.eFmdnegQHodeW4EUGyfEPKWOzyagXHG/IxuWyvQ';
