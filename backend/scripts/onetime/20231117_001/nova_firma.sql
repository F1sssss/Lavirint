...
SET @firma_pib = '03274055';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "EAGLE STONE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VELJKA VLAHOVIĆA BR. 16/7';
...
SET @firma_cert_pass = 'gAAAAABlVzk53yITrnYP99ZwM73le5cpC7OTMzNjNrp66KvMkW2OsZZA1GR-REluQW5HtFBV3mwONX9ylBjoYObvinGVJETXhA==';
...
SET @organizaciona_jedinica_efi_kod = 'tk683sf365';
SET @organizaciona_jedinica_naziv = 'EAGLE STONE 2';
SET @organizaciona_jedinica_adresa = 'VRT KADMA I HARMONIJA BB';
...
SET @naplatni_uredjaj_id = 'zw421ij750';
...
SET @operater_kodoperatera = 'qc512sd914';
SET @operater_ime = 'MILOŠ VUJOVIĆ';
SET @operater_korisnicko_ime = 'milos';
SET @operater_lozinka = '$pbkdf2-sha256$29000$LIUQIsRYa815b02JsXYuBQ$1Uh7B.ZQHkrOiSycGpVHiBgScKTTeP5aLYzG4DPJmWA';
