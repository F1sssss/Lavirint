...
SET @firma_pib = '03572641';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'DOO "PINO NEGRO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VASA RAIČKOVIĆA 27';
...
SET @firma_cert_pass = 'gAAAAABkmd_X8H1t6X45oh1FiF0TemoSzNQ3lwrGdGrq1BrNVHxMJGgh2_q1rA6iNCyC8bkG7y0wkvR03Wuc8JJpkPXj3A2SFA==';
...
SET @organizaciona_jedinica_efi_kod = 'vg658lt879';
SET @organizaciona_jedinica_adresa = 'NJEGOSEVA 32-33';
SET @organizaciona_jedinica_grad = 'ŽABLJAK';
SET @organizaciona_jedinica_drzava = 39;
SET @organizaciona_jedinica_naziv = 'PINO NEGRO';
...
SET @naplatni_uredjaj_id = 'kt084jc610';
...
SET @operater_kodoperatera = 'qy035at006';
SET @operater_ime = 'ALEKSANDAR PEKOVIC';
SET @operater_korisnicko_ime = 'aleksandar';
SET @operater_lozinka = '$pbkdf2-sha256$29000$kBKiNOZ8731PyRmDsPbeGw$vBjflnLezJAHNOpyxuQFwjKtTyRzs2TaimX.bekA9B4';
