...
SET @firma_pib = '03333531';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = '"ELITE TOURISM" D.O.O.';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VILA DANICA, MARIĆI BB';
...
SET @firma_cert_pass = 'gAAAAABkw6KOT-KVHEZK31PF5WAPh6SPwDOog7tkdmlQaDLF7b7PrRmtzfYL5ug8aOnqX5sxhCnZ6XDrZ2hTiWIWtEakxm-q5w==';
...
SET @organizaciona_jedinica_efi_kod = 'ol791jb515';
SET @organizaciona_jedinica_naziv = 'ELITE TOURISM';
SET @organizaciona_jedinica_adresa = 'MARIĆI BB';
...
SET @naplatni_uredjaj_id = 'mz717zj360';
...
SET @operater_kodoperatera = 'rd158nk336';
SET @operater_ime = 'CAGRI ESMEKAYA';
SET @operater_korisnicko_ime = 'cagri';
SET @operater_lozinka = '$pbkdf2-sha256$29000$CkGodc75f09prZXy3lsrRQ$/LnBumeoaqHUr1jtPt44G2VNhE/PH8p332JysoSEwos';
