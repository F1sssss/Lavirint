...
SET @firma_pib = '0510974715382';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'VANJA KUKOLJAC';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA 111';
...
SET @firma_cert_pass = 'gAAAAABk0LIU4uC717AUH5mNWKr14mm-lkDmJ001NXqaoAb5XE6RluZgzsNpa_N1zdFjoAzc2XiHEWRvBmlLaqoplyN78ItXWw==';
...
SET @organizaciona_jedinica_efi_kod = 'ob257co843';
...
SET @naplatni_uredjaj_id = 'vu325gd053';
...
SET @operater_kodoperatera = 'hg656uw264';
SET @operater_ime = 'VANJA KUKOLJAC';
SET @operater_korisnicko_ime = 'vanja';
SET @operater_lozinka = '$pbkdf2-sha256$29000$NqZUai3FGAPg3HsPAcC4dw$phlDop2Kex84tScFHD9Wvp/F0mSMv5D1COeAFXjHEso';
