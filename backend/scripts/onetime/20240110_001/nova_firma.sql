...
SET @firma_pib = '03623840';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "INVITO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'UL.MARŠALA TITA BB, POSLOVNI CENTAR SOFIKO';
...
SET @firma_cert_pass = 'gAAAAABlnxai-JHyq7gq1szbdYOsGV5mxL9JqQLztcocsXXrx_xRwOkTHsNSrLmGtKIXRG6nNA4T5cRnZKA3Z_WU4D-auhoJrA==';
...
SET @organizaciona_jedinica_efi_kod = 'fk561wf278';
...
SET @naplatni_uredjaj_id = 'vp122yd491';
...
SET @operater_kodoperatera = 'bw375if465';
SET @operater_ime = 'Kemal Ramović';
SET @operater_korisnicko_ime = 'kemal';
SET @operater_lozinka = '$pbkdf2-sha256$29000$eA/BGAOAsNYaA4CQcq41xg$l45RmZ8G9NxA3lbKDQ0M0ylD/FKVO0DS.1X8QyAm.8Y';
