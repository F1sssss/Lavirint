...
SET @firma_pib = '03603440';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "ZDRAVE KAPI"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '29.NOVEMBRA 12A';
...
SET @firma_cert_pass = 'gAAAAABlnxz5ytDUdzLKRc1GKnU20oU6df1zNhY2nOQXv0l9VwgGLewNbbUBeC_CmuQMypzYUaE5aZnpUkA8lCbD-trfj7TL2g==';
...
SET @organizaciona_jedinica_efi_kod = 'mt560ee288';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = '29 NOVEMBRA 12A';
...
SET @naplatni_uredjaj_id = 'gg693mq238';
...
SET @operater_kodoperatera = 'ap459ri703';
SET @operater_ime = 'VLADAN VELJIĆ';
SET @operater_korisnicko_ime = 'vladan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$kfLeOyekNIZwbm3NGYPQOg$xKN7W3wl7/HsxCLXt3WcmkEAphrpTsmTDIOyofaWJG8';
