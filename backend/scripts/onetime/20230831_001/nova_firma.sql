...
SET @firma_pib = '03342425';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "JT CONSULTING"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'LUZAC BB';
...
SET @firma_cert_pass = 'gAAAAABk8Fp3ck07WvTILScrcFSoz9iCI5MJBiFF0xzYdS1l90IQliK-6P3lAw6t9Xt8J5Q5xsyTfYc2lTauLsiOtQwZTfpsMA==';
...
SET @organizaciona_jedinica_efi_kod = 'sl887sz188';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'LUŽAC BB';
...
SET @naplatni_uredjaj_id = 'gg656ss105';
...
SET @operater_kodoperatera = 'ij347bg021';
SET @operater_ime = 'Nikola Vukic';
SET @operater_korisnicko_ime = 'nikola';
SET @operater_lozinka = '$pbkdf2-sha256$29000$0vofY.w9R2gt5ZzTOofQOg$v056pVsiZH8zDw0JNqnldlD.6fv6sSLOozWbbTPc5uk';
...
SET @operater_kodoperatera = 'cy900lg902';
SET @operater_ime = 'Vasilije Bugarin';
SET @operater_korisnicko_ime = 'vasilije';
SET @operater_lozinka = '$pbkdf2-sha256$29000$2ZvzPmeM8d4bw1jLeS9F6A$1h7BkEhuEl3v/7/LP/jsIj8Yn.v2lV0YcobAgmjQBhc';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
