...
SET @firma_pib = '02438577';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "RUS INVEST GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ALEKSANDROVA 41/A, ZELENIKA';
...
SET @firma_cert_pass = 'gAAAAABlCF12J-0SUDZhjDUHIn65P57LXF7wE0TbghQQ5O1He9EUiM7xqEYacfi4vpzWFMCeork5xfWZj4PCkydyJkL_F7WzLw==';
...
SET @organizaciona_jedinica_efi_kod = 'up814oo976';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'ALEKSANDROVA OBALA 41/A';
...
SET @naplatni_uredjaj_id = 'qo987nb385';
...
SET @operater_kodoperatera = 'vz104ia169';
SET @operater_ime = 'ARSEN ABAKAROV';
SET @operater_korisnicko_ime = 'arsen';
SET @operater_lozinka = '$pbkdf2-sha256$29000$GKM0Zqw1hvD.H0PonXMO4Q$gFOwCvhHYkdXXct1zHL3yYSRPjozT68YiMg99J8BSj8';
