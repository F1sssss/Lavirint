...
SET @firma_pib = '03594068';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "BAYRAM STYLE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ROZINO B.B.';
...
SET @firma_cert_pass = 'gAAAAABlioIGqMp76T_r-8tXNDDyR9CaBopHdLJzFvWL1_6WylUJGIQY0yz3BAr43mNtmLAE7G0zAptUasuU7qbkFy7zSo4rUg==';
...
SET @organizaciona_jedinica_efi_kod = 'jo897xk608';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'ROZINO BB';
...
SET @naplatni_uredjaj_id = 'dw305iv614';
...
SET @operater_kodoperatera = 'ra490ae869';
SET @operater_ime = 'BAYRAM UYAR';
SET @operater_korisnicko_ime = 'bayram';
SET @operater_lozinka = '$pbkdf2-sha256$29000$9n7vnZNSytm7954zJmSs1Q$rUUy.j4uxPkhCdQAi0pdZZeKkbJq6fdE83mYcCv6lEk';
