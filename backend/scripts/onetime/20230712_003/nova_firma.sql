...
SET @firma_pib = '03046010';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = '"SUBIĆ FAMILI" D.O.O.';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TREBINJSKA 22';
...
SET @firma_cert_pass = 'gAAAAABkrpXkikcbQm0k_M--jJa1hMdc_kq8ZVQfSru9tSXu0OMqM6r00C106Yvlj3t1lZmVuBK-N2OI3-sKqx9zcLUGWPDmhg==';
...
SET @organizaciona_jedinica_efi_kod = 'cf673xf738';
SET @organizaciona_jedinica_adresa = 'SUTORINA BB';
SET @organizaciona_jedinica_grad = 'HERCEG NOVI';
SET @organizaciona_jedinica_drzava = 39;
SET @organizaciona_jedinica_naziv = 'Privatni smjestaj SUTORINA';
...
SET @naplatni_uredjaj_id = 'ua782eq303';
...
SET @operater_kodoperatera = 'jr915ze444';
SET @operater_ime = 'Zoran Trifunović';
SET @operater_korisnicko_ime = 'zoran';
SET @operater_lozinka = '$pbkdf2-sha256$29000$dG5NyZkzRsgZoxQiZAyBcA$ieQWRcNrE3P4mwW7cjc2aNUDFJ9IDrQl66MpZTSYz9I';
