...
SET @firma_pib = '03497658';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. PROXIMA TECH';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BORE STANKOVIĆA 8';
...
SET @firma_cert_pass = 'gAAAAABlqkKLKfVyedrhaHQLYbijQ0bdKnTksCuR4jYwir6S5Om75lsD-LacQGXA9elndRLALNrMtWhf9Aei8gd8ojDYwbvNFA==';
...
SET @organizaciona_jedinica_efi_kod = 'me151pn179';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BORE STANKOVIĆA';
...
SET @naplatni_uredjaj_id = 'zs919qn717';
...
SET @operater_kodoperatera = 'rk306mg830';
SET @operater_ime = 'ANDREI KULAZHENKOV';
SET @operater_korisnicko_ime = 'andrei';
SET @operater_lozinka = '$pbkdf2-sha256$29000$X8vZu3dO6R3jfE8pZQwhhA$K/7cWKVCmDjJ9OGS/BrJpYTD88De8NzZ97/AiziEjdE';
