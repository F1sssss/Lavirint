...
SET @firma_pib = '2209988223011';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'XHENAN BECI';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ULICA 3 BR.4';
...
SET @firma_cert_pass = 'gAAAAABkp9pURKiC7GGYS2U95Z0N6nOfwtKXwRi2_-ra01bD1vQR_g-olVHNQ6SuSET_RL82d_Q1-JG9Gx3yZPH6gPhLGbcLgw==';
...
SET @organizaciona_jedinica_efi_kod = 'zn108gc253';
SET @organizaciona_jedinica_adresa = 'ULCINJSKI MOREPLOVCI BB';
SET @organizaciona_jedinica_grad = 'ULCINJ';
SET @organizaciona_jedinica_drzava = 39;
SET @organizaciona_jedinica_naziv = 'Taxi brod "DJULZULEJHA" reg. 588 UL';
...
SET @naplatni_uredjaj_id = 'ev796uv859';
...
SET @operater_kodoperatera = 'lt436qg891';
SET @operater_ime = 'XHENAN BECI';
SET @operater_korisnicko_ime = 'xhenan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$GUNICWEshRBizNl7j5HSeg$vd6KCu18XD0rC.jFo866izi9rZ5XGhG5u78q/W0yAEQ';
