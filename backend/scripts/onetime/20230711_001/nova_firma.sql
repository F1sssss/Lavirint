...
SET @firma_pib = '03531325';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "RISE TRADING"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABkrVPGjHsiOZ3JqQnQ_eB82hm1ylDUAy5XHIqiW-AodPAseC8I9bWTPGRkV3Bj4fOoESB2wfjsKAK40Jv3D4GAzlwTxg==';
...
SET @organizaciona_jedinica_efi_kod = 'ww332tz428';
...
SET @naplatni_uredjaj_id = 'il012jz618';
...
SET @operater_kodoperatera = 'ch647lx978';
SET @operater_ime = 'OGULCAN CABUKEL';
SET @operater_korisnicko_ime = 'ogulcan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$710LAaC0ljKmFGKs1ZoTog$JDPHBuNonUGzNzuDB5zaaRtt0VJbc8Bxl8nZYe7xAX4';
