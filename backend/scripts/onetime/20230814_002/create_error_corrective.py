...
operater = db.session.query(models.Operater).get(36)
komitent = db.session.query(models.Komitent).get(7489)
firma = db.session.query(models.Firma).get(22)
naplatni_uredjaj = db.session.query(models.NaplatniUredjaj).get(22)
valuta = db.session.query(models.Valuta).get(50)
corrected_invoice = db.session.query(models.Faktura).get(3310341)
...
stavka1.corrected_invoice_item_id = 7654215
...
stavka2.corrected_invoice_item_id = 7654216
...
stavka3.corrected_invoice_item_id = 7654217
...
stavka4.corrected_invoice_item_id = 7654218
...
stavka5.corrected_invoice_item_id = 7654219
