...
SET @firma_pib = '2906990277008';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'EMA MUSTAJBAŠIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILANA KUČA 25';
...
SET @firma_cert_pass = 'gAAAAABlDnyHtqpda6LIWTBTwOnIMwO6k75yngfIq6u-uqvAUMQqCHj7qS755b8S4k4p_wlExp9vjEXNMhtT4tp61F5zFeM8Mw==';
...
SET @organizaciona_jedinica_efi_kod = 'bw763kp233';
SET @organizaciona_jedinica_naziv = 'UKUSAN ZALOGAJ';
SET @organizaciona_jedinica_adresa = '29 NOVEMBRA BB';
...
SET @naplatni_uredjaj_id = 'ay479ye334';
...
SET @operater_kodoperatera = 'vo741gg223';
SET @operater_ime = 'EMA MUSTAJBAŠIĆ';
SET @operater_korisnicko_ime = 'ema';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xLi31npvrXXOGaMUwnhPaQ$VgNwtp5.TBTtjk7gqbarI0LA2d/Sg41udwcaUQLShzk';
