...
SET @firma_pib = '03640906';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "POPEX LAUNDRY"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VOJA LJEŠNJAKA BB';
...
SET @organizaciona_jedinica_efi_kod = 'aj725hl334';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'VOJA LJEŠNJAKA BB';
...
SET @naplatni_uredjaj_id = 'yj433nu877';
...
SET @operater_kodoperatera = 'hh713zf029';
SET @operater_ime = 'Mira Popovic';
SET @operater_korisnicko_ime = 'mira';
SET @operater_lozinka = '$pbkdf2-sha256$29000$HEOI0bq31lprzfl/DwGAEA$6wjaubdu6HAXhC4LGetrdAQm/oVK57AruC5SWFUwmoM';
