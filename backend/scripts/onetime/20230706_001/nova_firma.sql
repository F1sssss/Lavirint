...
SET @firma_pib = '03047385';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = '"CORTADO" D.O.O. - BERANE';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABkpoudAMad5-yGglY30ylzvXVDzatiDBPWr-LjPdzVODLJcETvOCm6-ALVm0UqBuN5KLL_tKGG9nXBhw9JXesHLqoFwg==';
...
SET @organizaciona_jedinica_efi_kod = 'wp651lu908';
SET @organizaciona_jedinica_adresa = '29 NOVEMBRA 15C';
SET @organizaciona_jedinica_grad = 'BERANE';
SET @organizaciona_jedinica_drzava = 39;
SET @organizaciona_jedinica_naziv = 'KOZMETICKI SALON CORTADO';
...
SET @naplatni_uredjaj_id = 'xa553pn847';
...
SET @operater_kodoperatera = 'vn561bs341';
SET @operater_ime = 'MEDINA TIGANJ';
SET @operater_korisnicko_ime = 'medina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$JIRwTillrHVuDUGIMeaccw$nzLJ5iLXzyJUBC1BDPnYn.YXtnpsB7P5iFiTBLldhgE';
