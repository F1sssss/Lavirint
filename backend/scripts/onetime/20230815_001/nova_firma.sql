...
SET @firma_pib = '03557677';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "GAMAN 11"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PRČANJ , NOGALJA BB';
...
SET @firma_cert_pass = 'gAAAAABk21cmDJu5i3zTKjAO6f2Jwytz2ksgy5gwGuBem-PyBJfMWjSHvdQdNXCuDn9IsRk26RmZWL0-suV-f0xwfCkkcFWH9Q==';
...
SET @organizaciona_jedinica_efi_kod = 'zl263bf754';
SET @organizaciona_jedinica_naziv = 'GAMAN 11';
SET @organizaciona_jedinica_adresa = 'PRČANJ , NOGALJA BB';
...
SET @naplatni_uredjaj_id = 'dy823aa233';
...
SET @operater_kodoperatera = 'fs419ie315';
SET @operater_ime = 'MARKO DRAŠKOVIĆ';
SET @operater_korisnicko_ime = 'marko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$.v9/T0mJMWYMIUSotTYGgA$AVT3MRQE9YWUPayWJYtrhRn2nrC8ieRD0sYQsIA4GSM';
