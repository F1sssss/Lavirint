...
SET @firma_pib = '0503975230017';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'MIODRAG SAMARDŽIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BIJELA BB';
...
SET @firma_cert_pass = 'gAAAAABl1mcAdmy2PNJ9HffnOWc0BJnVuaRBYgpg-OMj686vQxtYUikHlbr4qoUndZLZsdB8Gc5yPe4ia_yj55b-oJ25g8UTcg==';
...
SET @organizaciona_jedinica_efi_kod = 'jb383cv442';
SET @organizaciona_jedinica_naziv = 'ŠLEP SLUŽBA SAMARDŽIĆ';
SET @organizaciona_jedinica_adresa = 'JADRANSKA MAGISTRALA 23';
...
SET @naplatni_uredjaj_id = 'qy389uf091';
...
SET @operater_kodoperatera = 'hj396oi868';
SET @operater_ime = 'MIODRAG SAMARDŽiĆ';
SET @operater_korisnicko_ime = 'miodrag';
SET @operater_lozinka = '$pbkdf2-sha256$29000$iDHG.N8b4/y/V6pVqlWKUQ$KKt/AkVF9xTntqlNRq79zN93.FlFiH6sG18xuOmfFxg';
