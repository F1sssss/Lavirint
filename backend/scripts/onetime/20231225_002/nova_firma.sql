...
SET @firma_pib = '03256120';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "MULTISERVIS COMPANY"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ULICA MASLINA 20, LOKAL 2';
...
SET @firma_cert_pass = 'gAAAAABliWU1WukB_a3t3BPvakwTz5UFbSK511DewRffr3fIpdhfO8_Z82MeJz1Tv1hJH8kdc7pjNmUEB5CNcGaHWtggbV81sA==';
...
SET @organizaciona_jedinica_efi_kod = 'kl088md892';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MASLINA 20';
...
SET @naplatni_uredjaj_id = 'vy156je650';
...
SET @operater_kodoperatera = 'du611on588';
SET @operater_ime = 'PIERANGELO FINATTI';
SET @operater_korisnicko_ime = 'pierangelo';
SET @operater_lozinka = '$pbkdf2-sha256$29000$rpVyLqXUuleKcS5lbO19Tw$e3v2qMf0MFHlSvFGZKsRXsk9ix/DA5/u5blWbbZcqUE';
