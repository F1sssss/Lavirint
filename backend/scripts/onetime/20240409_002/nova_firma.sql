...
SET @firma_pib = '02417090';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ARDURA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BIJELA 163';
...
SET @organizaciona_jedinica_efi_kod = 'dc562pp101';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA 18';
...
SET @naplatni_uredjaj_id = 'is612ye642';
...
SET @operater_kodoperatera = 'ko471wh453';
SET @operater_ime = 'Jovan Mandić';
SET @operater_korisnicko_ime = 'jovan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$WsvZG0MoxdjbG4OQ0tr73w$sS2L.svXwU4I.IUziVEy2MYT/WdgRpnIU1/j7YLMVXI';
