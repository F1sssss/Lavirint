...
SET @firma_pib = '2711980212980';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'BORIS ĆORSOVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DONJA GORICA BB';
...
SET @firma_cert_pass = 'gAAAAABkuc4DMKZu1ZzrDgDnXItwywCBqCUeY-OnMpKTHtaZ7W18QOhArp9jC8LZLJNhdhJJLLAKcZu_4HFS_0LmHQP9prmINQ==';
...
SET @organizaciona_jedinica_efi_kod = 'fn652vr626';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BRVACKA 28, SUTOMORE';
...
SET @naplatni_uredjaj_id = 'yx175jq629';
...
SET @operater_kodoperatera = 'pq620ae526';
SET @operater_ime = 'BORIS ĆORSOVIĆ';
SET @operater_korisnicko_ime = 'boris';
SET @operater_lozinka = '$pbkdf2-sha256$29000$C0HIuTcGQEgJwZgTIkTofQ$tFFKw88iQUENrghguwnQnWrZugfE15y93kApTdcoy74';
