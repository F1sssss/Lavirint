...
SET @firma_pib = '03611523';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "AUTO CENTAR BOBO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NIKOLE PAŠIĆA BB';
...
SET @firma_cert_pass = 'gAAAAABlcCu71R6lUVfK_730isJXVPqN2Xe-kZYXC07Scbwm8HX9T6pC3B5L4r1fspORW8MH9wuMGfEUjhqnxC1j_TsVxBl0nQ==';
...
SET @organizaciona_jedinica_efi_kod = 'is320yb483';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NIKOLE PAŠIĆA BB';
...
SET @naplatni_uredjaj_id = 'fp161mu103';
...
SET @operater_kodoperatera = 'ht725wu109';
SET @operater_ime = 'BOJAN SERATLIĆ';
SET @operater_korisnicko_ime = 'bojan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$BQAAwBgjxJgTwtibc07JWQ$gdG7l/Ei6prLmGwLp9uijgxeB3zCAeEMlqgcv7bdZkE';
