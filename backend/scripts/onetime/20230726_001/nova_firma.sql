...
SET @firma_pib = '0705997220025';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'ĐURO POPOVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ŠKALJARI BR.18';
...
SET @firma_cert_pass = 'gAAAAABkwI2rFeyunrvswManjmfNAHvhmVJNqzcigcS0WKVxSVMmUR0usfPwaIFKpkhTfGgxeyUnhxmxjlqfJLPgIlbBiCZbvg==';
...
SET @organizaciona_jedinica_efi_kod = 'tj871gw637';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'ŠKALJARI 18';
...
SET @naplatni_uredjaj_id = 'ku279lu067';
...
SET @operater_kodoperatera = 'cr750xy017';
SET @operater_ime = 'ĐURO POPOVIĆ';
SET @operater_korisnicko_ime = 'djuro';
SET @operater_lozinka = '$pbkdf2-sha256$29000$IsR4D.F8791b613rPafUOg$MTznSeK3N0eCco4Gagr2aOithTC.iSBF7klAxvtAcc4';
