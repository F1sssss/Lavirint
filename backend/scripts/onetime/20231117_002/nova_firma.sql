...
SET @firma_pib = '03601978';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "EVANNA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '4. PROLETERSK, ZG. RAKA BOŽOVIĆA ST. BR. 1';
...
SET @firma_cert_pass = 'gAAAAABlVztHKjNUACIr-fMZDuUCJJbKjI0jZmrV6oi_aHgZJXrPOpDiaEdB8jlbSzv-uui4rDzAVFMNxB5LIaXx8HFRLOH4FQ==';
...
SET @organizaciona_jedinica_efi_kod = 'vo631es229';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = '4. PROLETERSKA, ZG. RAKA BOŽOVIĆA ST. BR. 1';
...
SET @naplatni_uredjaj_id = 'fz700vy666';
...
SET @operater_kodoperatera = 'xt385rd642';
SET @operater_ime = 'EVGENII PETIAGOV';
SET @operater_korisnicko_ime = 'evgenii';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xHiPsfaecy6l9P7/33uPcQ$3/AOVCktTBxS.dXzSnAWL/LXLgZ03RXe8EsgeffWy8s';
