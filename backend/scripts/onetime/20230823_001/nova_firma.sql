...
SET @firma_pib = '03553353';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = '"ELECTRICAL SERVICES" D.O.O. TIVAT';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PALIH BORACA ULAZ 22A, STAN 27';
...
SET @firma_cert_pass = 'gAAAAABk5cwFN4uT1FYuXab3pq7mq2bJUcRwE8UIi_4_fmLYsFdA6nx-jHGGKjWAp57r7nreXkhaw4W0XRcCqcJxsYLhijlscw==';
...
SET @organizaciona_jedinica_efi_kod = 'au042ob385';
SET @organizaciona_jedinica_naziv = 'ELECTRICAL SERVICES';
SET @organizaciona_jedinica_adresa = 'PALIH BORACA, ULAZ 22 STAN 27';
...
SET @naplatni_uredjaj_id = 'vq150ug426';
...
SET @operater_kodoperatera = 'kx048va659';
SET @operater_ime = 'Olivera Todorovic';
SET @operater_korisnicko_ime = 'olivera';
SET @operater_lozinka = '$pbkdf2-sha256$29000$o7R2bu2dc04pxTgHYCxlTA$NHGYPIoXM7UQzs6YwwKg5oEMM0Ne/aBbl1zJxCJZwGQ';
