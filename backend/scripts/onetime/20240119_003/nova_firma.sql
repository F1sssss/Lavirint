...
SET @firma_pib = '03485285';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "ALTURAS TECH"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'GRUDA BB';
...
SET @firma_cert_pass = 'gAAAAABlqkP3u2FF9jLnuh1-9zzT83DO7NYKicZeOBHvrnL-H6SdieFORgzkqgS21NB1KSUq2pubfIuCpoLPRQNi02SO6qQayg==';
...
SET @organizaciona_jedinica_efi_kod = 'bu683pe133';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'GRUDA – DONJE POLJE BB';
...
SET @naplatni_uredjaj_id = 'fh890cj305';
...
SET @operater_kodoperatera = 'zb113hi911';
SET @operater_ime = 'PAVEL KULAZHENKOV';
SET @operater_korisnicko_ime = 'pavel';
SET @operater_lozinka = '$pbkdf2-sha256$29000$jtGa03qvtZby/p9Tam3NWQ$hN.PH0nL0oFndlA26MQw9nn2ixx018jj5DZ0xCEcbiQ';
