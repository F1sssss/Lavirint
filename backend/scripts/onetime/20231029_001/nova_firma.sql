...
SET @firma_pib = '03062864';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "VP GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'FILIPA KOVAČEVIĆA B.B. (ZGRADA FRANETA)';
...
SET @firma_cert_pass = 'gAAAAABlPfyF1L-lDiSdYkN3Ljz8-M62ViHM1o0n9z4-J1AxtxcciPFxUY34iBkvc07SRypPbWL0B98LmusZ8uxS1gNeXid7UA==';
...
SET @organizaciona_jedinica_efi_kod = 'lw363ms146';
SET @organizaciona_jedinica_naziv = 'RENT A CAR VP GROUP';
SET @organizaciona_jedinica_adresa = 'ŽRTAVA FAŠIZMA, ZGRADA SUNCA';
...
SET @naplatni_uredjaj_id = 'nh587cp207';
...
SET @operater_kodoperatera = 'jb565qz358';
SET @operater_ime = 'IVAN VUŠUROVIĆ';
SET @operater_korisnicko_ime = 'ivan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xjhHSOmdU6p1TmnN2Zsz5g$YOR1mgjINhf5cLS.HRIaHKo5x7GgDK9HNF/hlgZVt2M';
