...
SET @firma_pib = '03545121';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "HAWAII BOAT TOURS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PALIH BORACA BR. 26, STAN 10';
...
SET @firma_cert_pass = 'gAAAAABk0kRFa8cPL6a8LkTKnH4v7EQpIk_gEFFw4jfBVYqxvMcR1GgArK6eriOnXe43bfTISu0ALiLUPGQMjgepy8PIq2TkSA==';
...
SET @organizaciona_jedinica_efi_kod = 'fu573lt326';
SET @organizaciona_jedinica_naziv = 'Hawaii Boat Tours';
SET @organizaciona_jedinica_adresa = 'Ulica Palih boraca 26';
...
SET @naplatni_uredjaj_id = 'ne237iz469';
...
SET @operater_kodoperatera = 'dh918qi467';
SET @operater_ime = 'Sava Šašić';
SET @operater_korisnicko_ime = 'sava';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xxiDEEIoxVhLyZnz/v//vw$AEDEr9sdhzcMR48G9O7hMKtvFABInyMPNZo35PEAxDQ';
