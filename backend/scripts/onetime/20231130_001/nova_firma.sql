...
SET @firma_pib = '02675781';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "BOJANIĆ COMPANY"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ĐENOVIĆI 55';
...
SET @firma_cert_pass = 'gAAAAABlaFC9XrBPMMWkaTg1mkok9CpKKyRs6pw46xDpr24SO0UqaztTejfB0dLbKXo8PsO3V4A1Uj0fHrOzooZTjGUbjA4xBQ==';
...
SET @organizaciona_jedinica_efi_kod = 'hk397it747';
SET @organizaciona_jedinica_naziv = 'GARNI HOTEL "MILICA"';
SET @organizaciona_jedinica_adresa = 'ĐENOVIĆI 22';
...
SET @naplatni_uredjaj_id = 'gc556oj296';
...
SET @operater_kodoperatera = 'jl383rp765';
SET @operater_ime = 'MILOŠ BOJANIĆ';
SET @operater_korisnicko_ime = 'milos';
SET @operater_lozinka = '$pbkdf2-sha256$29000$E.I8ByBkTKl1zlnr3RsjpA$hZh2CqLhySCmTJbA7e4Ki9UsAs70hnHy51qzKykp.3w';
