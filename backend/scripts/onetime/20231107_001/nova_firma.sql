...
SET @firma_pib = '03154297';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "A PLUS CONSTRUCTION"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BULEVAR IVANA CRNOJEVIĆA 163';
...
SET @firma_cert_pass = 'gAAAAABlSfrmLwo3Tb_TPckMs8vSqAYEoLzXxNtLrx_bk2HogFS5oDaL8RgKZyU8ZqsT0KgXoesWVTDl5ugNhsRrr9xJ7Wlv0w==';
...
SET @organizaciona_jedinica_efi_kod = 'zq471hn583';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'Bulevar Ivana Crnojevića 163';
...
SET @naplatni_uredjaj_id = 'ao105ih255';
...
SET @operater_kodoperatera = 'kj695fv839';
SET @operater_ime = 'Ena Mihailović';
SET @operater_korisnicko_ime = 'ena';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xZizdk4JwVjLea/VOqf0vg$oTcq/y5611w0R8OcAKTHwxtb6laaPIofzgOGzhK9G0k';
