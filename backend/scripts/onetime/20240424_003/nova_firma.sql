...
SET @firma_pib = '1810984272044';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'JAŠAR HUSIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'OSLOBOĐENJA BB';
...
SET @organizaciona_jedinica_efi_kod = 'sf855yl903';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'OSLOBOĐENJA BB';
...
SET @naplatni_uredjaj_id = 'zu899kq908';
...
SET @operater_kodoperatera = 'fe127eh870';
SET @operater_ime = 'Jašar Husić';
SET @operater_korisnicko_ime = 'jasar';
SET @operater_lozinka = '$pbkdf2-sha256$29000$fm/tvbe21hrDOKfUes95rw$Hunh2.mJaGslnuy/st0WlLaaVi2l0yJrcxtYkYZ2zC8';
