...
SET @firma_pib = '2010996210033';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'NEBOJŠA MILANOVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NIKOLE TESLE 134';
...
SET @organizaciona_jedinica_efi_kod = 'ei996uy375';
SET @organizaciona_jedinica_naziv = 'AUTO SERVIS MILANOVIC';
SET @organizaciona_jedinica_adresa = 'NIKOLE TESLE 134';
...
SET @naplatni_uredjaj_id = 'fd423lg713';
...
SET @operater_kodoperatera = 'qx263rt755';
SET @operater_ime = 'NEBOJSA MILANOVIC';
SET @operater_korisnicko_ime = 'nebojsa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$I0ToPacUYux9b00JIcQYQw$E2HZWqPYuFdeUrnd2A2AX9gI7J0WsYtPpFa2klODRq0';
