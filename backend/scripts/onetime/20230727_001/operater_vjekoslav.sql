...
-- Varijable
SET @firma_id = 819;
SET @firma_pib = '03344363';
SET @magacin_id = 860;
SET @naplatni_uredjaj_id = 876;
SET @firma_naziv = 'D.O.O. "PADEL MONTENGRO" - Tivat';

------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera

SET @operater_kodoperatera = 'mk178dl691';
SET @operater_ime = 'Vjekoslav Paskovic';
SET @operater_korisnicko_ime = 'vjekoslav';
SET @operater_lozinka = '$pbkdf2-sha256$29000$nnMupZRyDqE0hpBSas3Z.w$dmD5XeNJYnbK4S66fIQwEhl7O8j1veozHcP9JdDF69A';
