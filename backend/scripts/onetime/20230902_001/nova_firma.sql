...
SET @firma_pib = '03532763';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "REGZIT"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABk80R21Kxyn-vJp7NMR_D-jM0qv7zORDwzKusKkKUxrmCa9r67Y9iWIkKaxfCXdi8YTXAHDNXnU7YwTB_bTVAIXqOL0A==';
...
SET @organizaciona_jedinica_efi_kod = 'bn140zt067';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'IVE LOLE RIBARA 11';
...
SET @naplatni_uredjaj_id = 'um226yb570';
...
SET @operater_kodoperatera = 'co382te092';
SET @operater_ime = 'REGINA GATAULLINA';
SET @operater_korisnicko_ime = 'regina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$eg/hvPdey7lXCqFUao0xxg$az58VL51fXdKTj17nUkd.ufS.WojJbCPd03X8t5/onc';
