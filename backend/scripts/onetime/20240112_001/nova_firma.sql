...
SET @firma_pib = '02423600';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'OPŠTA STOMATOLOŠKA AMBULANTA "SORRISO" BAR';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MILA BOŠKOVIĆA H-6';
SET @firma_grad = 'BAR';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
...
SET @firma_cert_pass = 'gAAAAABloTL3tIHEpDpHT4Ssf9N8z8on4cVjpVwPrDpl82W3vIJRJwX70qP9J9MRCg_ZdIFdXb25bxQYpYpaL-5XypxdRVAcIA==';
...
SET @organizaciona_jedinica_efi_kod = 'ta698gd165';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MILA BOŠKOVIĆA H-6';
...
SET @naplatni_uredjaj_id = 'hi686we796';
...
SET @operater_kodoperatera = 'ro765iv369';
SET @operater_ime = 'Azra Mehovic';
SET @operater_korisnicko_ime = 'azra';
SET @operater_lozinka = '$pbkdf2-sha256$29000$NcZ4j1Hq/b/3HoPQOmdsrQ$A6n2luNoQxGBsHwM99FwOtB2wUalDMIuumorRBXl3MY';
...
SET @operater_kodoperatera = 'td015zf127';
SET @operater_ime = 'Sanela Zekovic';
SET @operater_korisnicko_ime = 'sanela';
SET @operater_lozinka = '$pbkdf2-sha256$29000$PAcgBACglJKScu79X.td6w$ManWIPQqZZZVUbsUbuplbBPi.zLJWL.TJLV3brURPiU';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
