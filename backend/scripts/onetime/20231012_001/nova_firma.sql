...
SET @firma_pib = '02814803';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ZETA PLUS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'GORIČANI BB';
...
SET @firma_cert_pass = 'gAAAAABlKB4SGO9J0kz2ORBUxVtlzvTs014qp_3Y9_Ag6SFxlR4eA67J5bafFanXG0Vm01qoa0OKMo-IR1HxW6Xy23VNr2GPbw==';
...
SET @organizaciona_jedinica_efi_kod = 'hl971pf749';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'GORIČANI BB';
...
SET @naplatni_uredjaj_id = 'ih522uf627';
...
SET @operater_kodoperatera = 'wl775hs974';
SET @operater_ime = 'Predrag Petrović';
SET @operater_korisnicko_ime = 'predrag';
SET @operater_lozinka = '$pbkdf2-sha256$29000$nXMOoRQiJATgvJcSwnivFQ$0N89qmK2KePwE1vc0jN37W1wg5EA2lb/WYeNPDMfIi0';
