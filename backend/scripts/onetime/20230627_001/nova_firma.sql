...
SET @firma_pib = '1512997216037';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'KSENIJA RADULOVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'JEREVANSKA 10';
...
SET @firma_cert_pass = 'gAAAAABkmtwwtLTUFlxtxYuSELYSYXwvmN1UFy3-ic7YOVVaUkSgK1CLZ8JHZrBdGNqm77JJAdCxP3vc6O2CowUGKiF2uBywLQ==';
...
SET @organizaciona_jedinica_efi_kod = 'qz017zz865';
SET @organizaciona_jedinica_adresa = 'VAKA ĐUROVIĆA BB';
...
SET @naplatni_uredjaj_id = 've967lo835';
...
SET @operater_kodoperatera = 'qc953yl224';
SET @operater_ime = 'KSENIJA RADULOVIĆ';
SET @operater_korisnicko_ime = 'ksenija';
SET @operater_lozinka = '$pbkdf2-sha256$29000$kVIqBWBMyfl/r7V2DkHovQ$vS0LTIzUmSpsQr99NngX7KjjNygr432yhwJdzubKZ48';
