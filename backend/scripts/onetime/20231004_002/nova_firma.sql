...
SET @firma_pib = '03406989';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "BEATRIX GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TRG SUNCA BR. 2';
...
SET @firma_cert_pass = 'gAAAAABlHV1D6HMPSuAJV20p4gx_4mPR2S4VFA_1nINci9Rivc0VvmV7vfK9ekF6Dthg73R4A3PagM0-pf7XAmT-q0oXZzBWKw==';
...
SET @organizaciona_jedinica_efi_kod = 'bz278fo072';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'JADRANSKI PUT BB';
...
SET @naplatni_uredjaj_id = 'pr887am929';
...
SET @operater_kodoperatera = 'vf536bo137';
SET @operater_ime = 'KILIKA CIHANGIR';
SET @operater_korisnicko_ime = 'kilika';
SET @operater_lozinka = '$pbkdf2-sha256$29000$vTdmbO19zxnjXEuJ8X6P8Q$LF/L7CJGhZzkl6olrY8EfPLMRpJWcskY0M/fXhGniEY';
...
SET @operater_kodoperatera = 'gq615rn462';
SET @operater_ime = 'SINEM KILIKCI';
SET @operater_korisnicko_ime = 'sinem';
SET @operater_lozinka = '$pbkdf2-sha256$29000$bw1h7N1bC2FMyRmDUIpx7g$/YD9NNtmFwnU8sD6MfAz5BJGmbWJzp7nqfol561Gqyo';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
