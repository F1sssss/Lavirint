...
SET @firma_pib = '03630528';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "GEM - FRIGOTRANSPORT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '5 BR.123, LJAJKOVIĆI';
SET @firma_grad = 'ZETA';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
...
SET @firma_cert_pass = 'gAAAAABl4E7TeyTZpVoxxNWjNuBZ8DdVQYfBwEh3XgLyztS8QirzoeMYOrfGiWCDpdoqLUFFfWxV5q6LuL47hlAKqndM6Ab7rw==';
...
SET @organizaciona_jedinica_efi_kod = 'ub061zd601';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'XXXVI ULICA MAHALA BB';
SET @organizaciona_jedinica_grad = 'ZETA';
...
SET @naplatni_uredjaj_id = 'fg144rj884';
...
SET @operater_kodoperatera = 'fv978sq783';
SET @operater_ime = 'MILOS DJUROVIC';
SET @operater_korisnicko_ime = 'milos';
SET @operater_lozinka = '$pbkdf2-sha256$29000$ROi915qTEqJUCsFYi/F.Lw$T1lZPI6yT8sEeMlOkraOIROPJswvrdsXGges0n.xa78';
