...
SET @firma_pib = '03352498';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "TRAVEGO HERCEG NOVI"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NJEGOŠEVA 87A';
...
SET @firma_cert_pass = 'gAAAAABk8WozhE3euNx-Owt67Isaq9aPCjMbJNnx00qo3I1D7bX99Mnx5cQhL9CTBOPd7wvCuZdyJgpGoD86IVi6FTsSifjs0Q==';
...
SET @organizaciona_jedinica_efi_kod = 'on203rx378';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA 87a';
...
SET @naplatni_uredjaj_id = 'qs192fz461';
...
SET @operater_kodoperatera = 'gk200ad434';
SET @operater_ime = 'Slobodan Jeremić';
SET @operater_korisnicko_ime = 'slobodan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$q9Va6937nxPC2Htv7b03Rg$ngW7N6n6IhS/HyG0k64Kyj2kL6FNn6rZ8FH7OBcWjXo';
