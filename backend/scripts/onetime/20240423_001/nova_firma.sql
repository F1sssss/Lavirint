...
SET @firma_pib = '03637077';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "PRINT POINT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'CRNOGORSKIH SERDARA 26';
...
SET @organizaciona_jedinica_efi_kod = 'bm894mi835';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'CRNOGORSKIH SERDARA 26';
...
SET @naplatni_uredjaj_id = 'ad517or196';
...
SET @operater_kodoperatera = 'rn310qt818';
SET @operater_ime = 'IRENA IVANOVIC';
SET @operater_korisnicko_ime = 'irena';
SET @operater_lozinka = '$pbkdf2-sha256$29000$oRRCSImxtnYupbSWEiKE8A$qtPvZoL2gXN5oZ9k5Q2uqjX/lxzTgTt2rTNyd3Qc7uU';
