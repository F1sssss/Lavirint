...
SET @firma_pib = '03584810';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "TWO JAYS"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABl8-oTxu11zP_WLNAg3F2X-a2zTFQiWXIC1FeAHp308srEUTD8PyfhP_Ot-EUECc80t0-zxcoslCzXrKCjCUWTQQ8gBg==';
...
SET @organizaciona_jedinica_efi_kod = 'rt784wu881';
...
SET @naplatni_uredjaj_id = 'gr103nu678';
...
SET @operater_kodoperatera = 'ap891sb369';
SET @operater_ime = 'TANJYA LEE JACOBS';
SET @operater_korisnicko_ime = 'tanyalee';
SET @operater_lozinka = '$pbkdf2-sha256$29000$lhKC0Nqbk7KWMmbsHQMAoA$D/4hNvTn6ONxQrnNDhI0E3aY1X5X2aqAV89ih2CkXW0';
