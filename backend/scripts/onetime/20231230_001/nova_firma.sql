...
SET @firma_pib = '03595633';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "BONITET PLUS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VELJKA VLAHOVIĆA BR.5';
...
SET @firma_cert_pass = 'gAAAAABlkAVQp5zSyJGDuB24B2sp9AnvEqTy9W-rBsMYCjCB3IbYmkAeS-Ejx39_pdAMKSMpeokjasj_ANdxpuYHlkfiTaYtaw==';
...
SET @organizaciona_jedinica_efi_kod = 'ig924ne771';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'VELJKA VLAHOVICA 5';
...
SET @naplatni_uredjaj_id = 'pg540ik002';
...
SET @operater_kodoperatera = 'rh928te673';
SET @operater_ime = 'BOJANA ANIČIĆ';
SET @operater_korisnicko_ime = 'bojana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$9Z7zvndujdE6x/j/H0PImQ$8N5NBapY2wOxRetTnxxnftAaOSTBInHsFAKaDxqMAzs';
