...
SET @firma_pib = '03619559';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "MAK MNE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TREBINJSKA BB';
...
SET @firma_cert_pass = 'gAAAAABlwir39b3J11QgGb6Hv8-E_ViIhjcQMMXk6etUVATaVe7piPgvepLR6neQklaiIV2nGjtZuxaxB9wqAscaPrTbCUzdiQ==';
...
SET @organizaciona_jedinica_efi_kod = 'oy481ds878';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'TREBINJSKA BB';
...
SET @naplatni_uredjaj_id = 'xp287nz159';
...
SET @operater_kodoperatera = 'zy032qp791';
SET @operater_ime = 'ALENA KUZNETSOVA';
SET @operater_korisnicko_ime = 'alena';
SET @operater_lozinka = '$pbkdf2-sha256$29000$SWlNCcEYw5hzzllLSQmh1A$Mh0ZxrAokDB1irIICVTaokp79AtyhlGG.KrJoCqWxv4';
