...
SET @firma_pib = '02422042';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "EVONA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'JOVANA VAVIĆA BR.5';
SET @firma_grad = 'HERCEG NOVI';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
...
SET @firma_cert_pass = 'gAAAAABgscRemZk9i63evumnuNtvr9hYuZPTnbg9PriY5v_nauSOlgrnFTMHnRNRZNerUCb9dhOB0mfuM4p5yKrdZ0uEM973mg==';
...
SET @organizaciona_jedinica_efi_kod = 'xb502hh346';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'Sava Ilića 14';
SET @organizaciona_jedinica_grad = 'HERCEG NOVI';
...
SET @naplatni_uredjaj_id = 'es486fp499';
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera: natasa2

SET @operater_kodoperatera = 'jx287mb932';
SET @operater_ime = 'Nataša Mrđanov';
SET @operater_korisnicko_ime = 'natasa2';
SET @operater_lozinka = '$pbkdf2-sha256$29000$l7IWQshZ653zHsM4B.CcUw$pxw2AXhWpGKkIX/FBYGihvzZsvcKHDu4tpFzHZSCBns';
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera: jelena2

SET @operater_kodoperatera = 'pe123cw505';
SET @operater_ime = 'Jelena Sladović';
SET @operater_korisnicko_ime = 'jelena2';
SET @operater_lozinka = '$pbkdf2-sha256$29000$cE4JgVDq3fu/1xrDOEcoxQ$olFbPwygnreRaE7QGnVQwf15t/SmgdmuTdlc22.My5c';
SET @operater_pib = @firma_pib;
SET @operater_kljuc = '4AVDH4TTKWRRM5KYGYHBCUNTPG7KWEXJ';  -- Deprecated
SET @operater_admin = 0;
SET @operater_aktivan = 1;
