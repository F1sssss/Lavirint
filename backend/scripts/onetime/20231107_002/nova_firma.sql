...
SET @firma_pib = '1606995215038';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'JOVANA NIŠAVIĆ';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'RAKONJE BB';
SET @firma_grad = 'BIJELO POLJE';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
SET @firma_je_aktivna = 1;
SET @firma_cert_pass = 'gAAAAABlSgC3Dz6F87eDFeSpPAC7VIIuyVP3nD5J5p0Lp6unWxB2xGNV4l4CY6rf1C0r7iQLyePDgl9ARBGvFl0nAmuef4btOw==';
...
SET @organizaciona_jedinica_efi_kod = 'ww039gn631';
SET @organizaciona_jedinica_naziv = 'PREDUZETNIK JOVANA NIŠAVIĆ TEPIH SERVIS NIŠAVIĆ';
SET @organizaciona_jedinica_adresa = 'JADRANSKA 47';
SET @organizaciona_jedinica_grad = 'BIJELO POLJE';
...
SET @naplatni_uredjaj_id = 'es472jr860';
...
SET @operater_kodoperatera = 'da243bq539';
SET @operater_ime = 'JOVANA NIŠAVIĆ';
SET @operater_korisnicko_ime = 'jovana';
SET @operater_lozinka = '$pbkdf2-sha256$29000$YqwVIiREqLVWSqmV0nqPMQ$66VJ8DLTKWK9yDDlYfjPlTS0ZskMAE1Q0s0lxOVq88U';
