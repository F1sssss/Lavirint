...
SET @firma_pib = '03637859';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "TURISTIČKA VISIT MONTENEGRO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'TABAČINA BR. 169';
...
SET @organizaciona_jedinica_efi_kod = 'cm596yg331';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'KOTORSKA BB';
...
SET @naplatni_uredjaj_id = 'qj778lc704';
...
SET @operater_kodoperatera = 'po920mj970';
SET @operater_ime = 'BORIS TOMČUK';
SET @operater_korisnicko_ime = 'boris';
SET @operater_lozinka = '$pbkdf2-sha256$29000$vffeO.f8HyPEuPf.P4ewFg$PB2e7SoXLB9OECl9Mz5w6ANiNxHJVi9SrajnmpNJOXc';
