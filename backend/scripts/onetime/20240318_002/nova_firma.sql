...
SET @firma_pib = '03251454';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "EL EXITO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '29. NOVEMBAR BR. 18A';
...
SET @organizaciona_jedinica_efi_kod = 'qu868qo921';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = '29 NOVEMBRA BR.18A';
...
SET @naplatni_uredjaj_id = 'nq492yb347';
...
SET @operater_kodoperatera = 'nl919iv620';
SET @operater_ime = 'ŽARKO BOJOVIĆ';
SET @operater_korisnicko_ime = 'zarko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$be0dI.RcK8X4v1fKubeWUg$K05ZKww2bX2yuGA.fMI/X4qNAbXNJdSM54j/t1tr7CE';
