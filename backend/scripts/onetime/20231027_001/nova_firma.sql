...
SET @firma_pib = '03426521';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "RSB1510"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'MAINSKI PUT BR. 56';
...
SET @firma_cert_pass = 'gAAAAABlO6b5gdafFjssuVn4dUoheY7-gzDx2ARkRAky69livTJIoDgx2fmcIfZgf9NxO8-qTNNNyk2f1Gm9XDutJiTjrNZ27A==';
...
SET @organizaciona_jedinica_efi_kod = 'ub471jk777';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'MAINSKI PUT 56';
...
SET @naplatni_uredjaj_id = 'zb135ne150';
...
SET @operater_kodoperatera = 'xm509qh151';
SET @operater_ime = 'ALEKSANDRA ALEKSANDRA';
SET @operater_korisnicko_ime = 'aleksandra';
SET @operater_lozinka = '$pbkdf2-sha256$29000$V.r9nzMmZIyxtrY2ZkzJeQ$su8wxLiFgNu7RMggmX6DepdGfHr0bK81GYVBURfZfGE';
