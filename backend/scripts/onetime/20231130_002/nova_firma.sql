...
SET @firma_pib = '03610357';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "RAIČEVIĆ MNE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'VUKA MIĆUNOVIĆA, ZGRADA 2, STAN 4';
SET @firma_grad = 'NIKŠIĆ';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
SET @firma_je_aktivna = 1;
SET @firma_cert_pass = 'gAAAAABlaIBFIM0fj6H9g4p3B-fGmNGylhYvUb7dLRvz56ORnPWOR3n36DHjWSeP142jaNv-K7nVSLiG0fkNvkZ7v7t9eFx2gw==';
...
SET @organizaciona_jedinica_efi_kod = 'ev474rl373';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'VUKA MIĆUNOVIĆA, ZGRADA 2';
SET @organizaciona_jedinica_grad = 'NIKŠIĆ';
...
SET @naplatni_uredjaj_id = 'lk588nf022';
...
SET @operater_kodoperatera = 'kh647av616';
SET @operater_ime = 'MARINA RAICEVIC';
SET @operater_korisnicko_ime = 'marina';
SET @operater_lozinka = '$pbkdf2-sha256$29000$LEXoXUtJifE.x5jTmnNuzQ$rucdVlY4oG0ep8xXD47ZqeHdpElwCeX5wZ1sbRhBQ3g';
...
------------------------------------------------------------------------------------------------------------------------
-- Selekcija operatera 1 za Excel 
...
SET @operater_kodoperatera = 'bm364ww498';
SET @operater_ime = 'MARKO RAICEVIC';
SET @operater_korisnicko_ime = 'marko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$HqO0VuqdEyJkTInRGqM0Zg$1gXarhG.gKNl45ZzVqlOekAWpQz27rZf7Ai2MCm8uvY';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
