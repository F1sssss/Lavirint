...
SET @firma_pib = '03219364';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "DEAMAT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'JADRANSKA MAGISTRALA BB FOBROTA';
SET @firma_grad = 'KOTOR';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
SET @firma_je_aktivna = 1;
SET @firma_cert_pass = 'gAAAAABlwhJokIy81ToaE1s3iPTVFwPosZc9S_mcXQx4egVhLsF831dbGMaIhpPEra_79ZfG6aMiz6dPsnmQ0k7fyCQHG93ehQ==';
...
SET @organizaciona_jedinica_efi_kod = 'ck882ar395';
SET @organizaciona_jedinica_naziv = 'STOLARSKE USLUGE';
SET @organizaciona_jedinica_adresa = 'DOBROTA BB';
...
SET @naplatni_uredjaj_id = 'de609tt770';
...
SET @operater_kodoperatera = 'po946gu086';
SET @operater_ime = 'MARKO RAŠOVIĆ';
SET @operater_korisnicko_ime = 'marko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$F.Jca22tlbJWSonxvjcmRA$fn5W0n3bYYf75iWF8zlgVh.XEYGuvO0uoFJ2cBWYE5o';
