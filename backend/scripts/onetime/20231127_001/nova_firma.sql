...
SET @firma_pib = '03604497';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "GEO-LUX"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DAPSIĆE BB';
...
SET @firma_cert_pass = 'gAAAAABlZDiB_tC6DGxP2D4_wTcSKvLPJ_PUj8SSqdMIL7jK-VRufRjM0gTVOHm1iObnuMhAPdc_IwY2QXClRy6PEPGC-rXKuQ==';
...
SET @organizaciona_jedinica_efi_kod = 'jw581mk924';
...
SET @naplatni_uredjaj_id = 'gx913hl171';
...
SET @operater_kodoperatera = 'zk339cd658';
SET @operater_ime = 'DJOLE LUTOVAC';
SET @operater_korisnicko_ime = 'djole';
SET @operater_lozinka = '$pbkdf2-sha256$29000$FCIkpPTee0/pXUspRai19g$w88SuiGa6zowm4ywiecCKHxd60cpMlv71SpOFajcqEc';
