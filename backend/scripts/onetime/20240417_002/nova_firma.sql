...
SET @firma_pib = '03173526';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "CONTACTTANGO"';
SET @firma_pdvbroj = '';
...
SET @organizaciona_jedinica_efi_kod = 'po104qf744';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NJEGOŠEVA 6';
...
SET @naplatni_uredjaj_id = 'xp647rv551';
...
SET @operater_kodoperatera = 'np234vz741';
SET @operater_ime = 'Olivera Todorović';
SET @operater_korisnicko_ime = 'olivera';
SET @operater_lozinka = '$pbkdf2-sha256$29000$m7M2JuQ8J.S8N2astXYuZQ$Og29IIdDICrKOIH.bHcGe3sEF3qMJn6iKgEXNtvupsY';
