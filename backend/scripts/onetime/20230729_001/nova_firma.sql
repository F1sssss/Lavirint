...
SET @firma_pib = '02187434';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "LAZ PROMET"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DAPSIĆE B.B.';
...
SET @firma_cert_pass = 'gAAAAABkxHa7NaeqkAGUV8Kij3dFZWmkna6qlfGxEGHh9gdQ3RydFXQhWW7YKeJde9hMhEoz4iXJdEFB03ImFHqWKFQCG0Ju0w==';
...
SET @organizaciona_jedinica_efi_kod = 'gc904ni868';
...
SET @naplatni_uredjaj_id = 'wi776ly817';
...
SET @operater_kodoperatera = 'tg311pf717';
SET @operater_ime = 'Milosav Lutovac';
SET @operater_korisnicko_ime = 'milosav';
SET @operater_lozinka = '$pbkdf2-sha256$29000$EYKQcm6NsfZ.j1FKqRWiNA$4cZmkMLP9QpCJ4ol7XEOohkaSevm45Bg9TDPVEhHY8A';
