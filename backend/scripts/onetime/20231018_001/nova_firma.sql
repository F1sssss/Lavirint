...
SET @firma_pib = '03591425';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "PEACH PEOPLE"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'PREDGRAĐE 38';
...
SET @firma_cert_pass = 'gAAAAABlL-oDnonzWdE7Oz9q_4bhVxD6efI0H439Pi9q1dF6JWK4m8_eeQLUUQ-ni2jN61WPAWTL-yuO7s18dnJNpvngXIptcg==';
...
SET @organizaciona_jedinica_efi_kod = 'tb622ul443';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'PREDGRAĐE 38';
...
SET @naplatni_uredjaj_id = 'hu291hu891';
...
SET @operater_kodoperatera = 'yb170mm268';
SET @operater_ime = 'MILICA KNEZEVIC';
SET @operater_korisnicko_ime = 'milica';
SET @operater_lozinka = '$pbkdf2-sha256$29000$QogxBoDQ.l9rDSEEoLT2vg$/W/vlagRsiFogBxxjjJJTyKapSe.EPIuk/pFu1SqLuc';
