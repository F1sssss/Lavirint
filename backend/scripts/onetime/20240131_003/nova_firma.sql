...
SET @firma_pib = '03614395';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "SAMET SMZ"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABluea8d_ZC6YnksWKHHozGDPQBH82hNXnIt2TpGTHN0fWSRHJolHHmKMXVD0AEmoJH23YbK7v_MZ4nowNwK6jKa_HpYg==';
...
SET @organizaciona_jedinica_efi_kod = 'hj197br910';
...
SET @naplatni_uredjaj_id = 'fk514jy315';
...
SET @operater_kodoperatera = 'if330jf145';
SET @operater_ime = 'SAMET SEMIZ';
SET @operater_korisnicko_ime = 'samet';
SET @operater_lozinka = '$pbkdf2-sha256$29000$gVBK6f1fa21tLaU0xphzDg$X7.XPJ0PNptSRKphvIHhMHbuMdn8k2U2AzohxmLKioY';
