...
SET @firma_pib = '03228100';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "JANAT"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'XXI, ZGARADA 3, STAN 5 PETROVAC';
...
SET @organizaciona_jedinica_efi_kod = 'ab188hr670';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'XXI BB';
...
SET @naplatni_uredjaj_id = 'md370xf484';
...
SET @operater_kodoperatera = 'vn361fb639';
SET @operater_ime = 'ANDREY KALININ';
SET @operater_korisnicko_ime = 'andrey';
SET @operater_lozinka = '$pbkdf2-sha256$29000$F4KwVgrBWAuBMAbA2FtLKQ$QESyZhnjk9xYbWNSXQeoU1feIcY7tPpCommlSDE0b8M';
