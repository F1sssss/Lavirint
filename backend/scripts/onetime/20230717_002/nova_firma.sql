...
SET @firma_pib = '0403998211074';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'DRITON DALIPI';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ULCINJ';
...
SET @firma_cert_pass = 'gAAAAABktWPAItvZ2YExJi08LTaHA_UiId065hSt-wpN30FnFqAWJVSuGMD5yajLmXUoKLWt5qGdEq_dQf8Ys7PV9xwq2yvBDg==';
...
SET @organizaciona_jedinica_efi_kod = 'ks063fn973';
SET @organizaciona_jedinica_naziv = 'POSLASTICARNICA "PORTO GRANDE"';
SET @organizaciona_jedinica_adresa = 'VELIKA PLAZA - Port Milena';
...
SET @naplatni_uredjaj_id = 'xg203sr555';
...
SET @operater_kodoperatera = 'ts277fo047';
SET @operater_ime = 'DRITON DALIPI';
SET @operater_korisnicko_ime = 'driton';
SET @operater_lozinka = '$pbkdf2-sha256$29000$hZASImSMESJk7J0z5rzXmg$hwsratE4eOFdduu1G8MtkKanpeN/bejWXj5Q7L9bkw4';
