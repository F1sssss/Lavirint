...
SET @firma_pib = '02130530';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "NV VUK"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ANDRIJEVAČKOG BATALJONA B.B.';
...
SET @organizaciona_jedinica_efi_kod = 'ch593xy161';
SET @organizaciona_jedinica_naziv = 'K&K COP NOVOVIC';
SET @organizaciona_jedinica_adresa = 'M.MALISICA BR.1';
...
SET @naplatni_uredjaj_id = 'xw237tv647';
...
SET @operater_kodoperatera = 'ht619iz071';
SET @operater_ime = 'Stefan Novović';
SET @operater_korisnicko_ime = 'stefan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$ZWwt5ZyTUgqhlPL./98b4w$zQvK6AdCoa1PbgCrvu9QM8TgxJwMub.VEInAn5bjSek';
