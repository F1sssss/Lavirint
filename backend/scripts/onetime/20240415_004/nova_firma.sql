...
SET @firma_pib = '03461874';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "REXREX"';
SET @firma_pdvbroj = '';
...
SET @organizaciona_jedinica_efi_kod = 'cg554rf934';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BUDVA BB';
...
SET @naplatni_uredjaj_id = 'fz806sl078';
...
SET @operater_kodoperatera = 'wk212sy369';
SET @operater_ime = 'CANSU ALICI';
SET @operater_korisnicko_ime = 'cansu';
SET @operater_lozinka = '$pbkdf2-sha256$29000$D0EoxVirtTYmRCgFIGRsjQ$PlFyeaiSiM1H3TBXllmthPobiFnzFS5kEYXZfuGF0uc';
