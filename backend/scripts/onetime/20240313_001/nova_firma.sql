...
SET @firma_pib = '03637689';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "HIRIN HERO CO"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'OKTOBARSKE REVOLUCIJE 86';
...
SET @firma_cert_pass = 'gAAAAABl8W6qIjQZc8r0ZxesUVZ6QAlE92baaDYm-Rr0HPSW0YEZbT6QHQqGsHJ1VViW7L3mFiQe8RGa9F8RtxqNNGRyE-PF9g==';
...
SET @organizaciona_jedinica_efi_kod = 'rh792uh487';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'OKTOBARSKE REVOLUCIJE 86';
...
SET @naplatni_uredjaj_id = 'av292ew549';
...
SET @operater_kodoperatera = 'mt360so519';
SET @operater_ime = 'Dunja Popovic';
SET @operater_korisnicko_ime = 'dunja';
SET @operater_lozinka = '$pbkdf2-sha256$29000$uBfinPMeA.D8v1eq9T5HKA$it.MR9S/p2vuB4FdwgvwzEcSs4Lw/DCdZJWOQe7ABJ8';
