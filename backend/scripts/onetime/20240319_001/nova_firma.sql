...
SET @firma_pib = '03217795';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "SUMMICA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'JADRANSKI PUT BB';
...
SET @organizaciona_jedinica_efi_kod = 'nv110pr848';
...
SET @naplatni_uredjaj_id = 'ra052an905';
...
SET @operater_kodoperatera = 'ci837gj373';
SET @operater_ime = 'GULNUR TIRYAKILER';
SET @operater_korisnicko_ime = 'gulnur';
SET @operater_lozinka = '$pbkdf2-sha256$29000$8V5rbQ1hzBnjvBfCeA.BsA$LAU5RrhJaAEwTg/PMaC0sRz1lmH.eawqPztoTm.VtiI';
