...
SET @firma_pib = '02078333';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "CENTAR ZA SPORT I REKREACIJU"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DUŠANA OBRADOVIĆA B.B.';
SET @firma_grad = 'PLJEVLA';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
SET @firma_ziroracun = '';
SET @firma_je_aktivna = 1;
SET @firma_cert_pass = 'gAAAAABl6GyWKZ3lRHxq1bV-nYjwVGPXi4V09vpdlJPvY1vScpeCngRJ-sRD-Ot41rmmmPSkfIiW4Gw8g-1XkWoNogNHikYD1Q==';
...
SET @organizaciona_jedinica_efi_kod = 'ez051kz036';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'DUŠANA OBRADOVIĆA BB';
SET @organizaciona_jedinica_grad = 'PLJEVLJA';
...
SET @naplatni_uredjaj_id = 'lp084wm084';
...
SET @operater_kodoperatera = 'mc330la097';
SET @operater_ime = 'BORJAN DZOGAZ';
SET @operater_korisnicko_ime = 'borjan';
SET @operater_lozinka = '$pbkdf2-sha256$29000$iXEuRYjxfq.VUiol5DxHCA$xNaxf4SHk5DL4fZSfC68UJaM3gfbRWgtkAcbA0bkiGE';
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera 2

SET @operater_kodoperatera = 'vl275dh556';
SET @operater_ime = 'SLAVISA VRANES';
SET @operater_korisnicko_ime = 'slavisa';
SET @operater_lozinka = '$pbkdf2-sha256$29000$9V4LgdAaA.Bca41RKoXwXg$Wos1teEDG.s6hesHLi5Alr1.rx/pi7Ge/2wtjaYqTu0';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje podešavanja operatera 2
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera 3

SET @operater_kodoperatera = 'zs320ph676';
SET @operater_ime = 'DANKA LONCAR';
SET @operater_korisnicko_ime = 'danka';
SET @operater_lozinka = '$pbkdf2-sha256$29000$xLg3ZkwJAeC8FwJgbG2tVQ$dtX3Ytd5lTU.Guvi7cfzE/4/LddN0USag4yPu56YZ5w';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje podešavanja operatera 3
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje operatera 4

SET @operater_kodoperatera = 'hh306sz315';
SET @operater_ime = 'Tomislav Gogić';
SET @operater_korisnicko_ime = 'tomislav';
SET @operater_lozinka = '$pbkdf2-sha256$29000$RIjR.h9jbC0FIMSYs3buPQ$BZAWS2YsJUbQoiyRGy5o3YT3dh5Nlm4Vnd.NTXZVHmI';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
...
------------------------------------------------------------------------------------------------------------------------
-- Dodavanje podešavanja operatera 4
