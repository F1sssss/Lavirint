...
SET @firma_pib = '03606139';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "IVANOVIĆ TRANS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'DUNAVSKA BR. 49';
...
SET @firma_cert_pass = 'gAAAAABlS6gVBiv25lRvWSF05WdSDDJBEVkt4C2y_zh_hOF17ceRfgN4K3I82l-zTXcl5Kab3HZAJyvYQ4x6divxOA4JLXvIGA==';
...
SET @organizaciona_jedinica_efi_kod = 'ma997hn828';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'DUNAVSKA 49';
...
SET @naplatni_uredjaj_id = 'yv861ny066';
...
SET @operater_kodoperatera = 'pi519pb036';
SET @operater_ime = 'MARKO IVANOVIC';
SET @operater_korisnicko_ime = 'marko';
SET @operater_lozinka = '$pbkdf2-sha256$29000$2ftfK8W4txYiRCglpHTuPQ$2FIpz6GLL6xJgwzrsWDVHRPF2CMzINVw1tL3Bd/2aIs';
