...
SET @firma_pib = '03612520';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "POSITIVE SOLUTIONS LTD"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'ULICA MASLINA 20, LOKAL BR.2';
...
SET @firma_cert_pass = 'gAAAAABlueM_j8daI6Or6PpX8NJnDcY6KVqYcJHiHDiCFGcclh94VPo1oPoRu4ZmpleeB4OHMEXfNO1N3DmXCuxaCaQ_VVF2Ng==';
...
SET @organizaciona_jedinica_efi_kod = 'vx013zk330';
...
SET @naplatni_uredjaj_id = 'yo575fq630';
...
SET @operater_kodoperatera = 'au154jg145';
SET @operater_ime = 'AHMET KARABIBER';
SET @operater_korisnicko_ime = 'ahmet';
SET @operater_lozinka = '$pbkdf2-sha256$29000$zjnH.P./l7LW.r.31lorZQ$fPpvQU2b.eqGb5dKT/oFGJDre17hDDpPHI9vWQsjLF4';
