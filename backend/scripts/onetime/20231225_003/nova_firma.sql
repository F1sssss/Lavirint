...
SET @firma_pib = '02431351';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "RASTA"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'STARI GRAD BB';
...
SET @firma_cert_pass = 'gAAAAABliYA4xbw_Gf7_Zsnvv3ExLV9M7mqrA10YAQ7HAQKSeE_ioVarVBE3b2ri7ZePjnnRXL3BvXmWYuegKL3jT0OCFwKBvg==';
...
SET @organizaciona_jedinica_efi_kod = 'vo036xw177';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'STARI GRAD BB';
...
SET @naplatni_uredjaj_id = 'sm542oq511';
...
SET @operater_kodoperatera = 'em909xs684';
SET @operater_ime = 'LAZAR PIPER';
SET @operater_korisnicko_ime = 'lazar';
SET @operater_lozinka = '$pbkdf2-sha256$29000$v3eOkXLOWSultNZ6L.W8dw$obhl8jofPniql5RHDZmmwia6NKrGSahgTo5G8TWnwrw';
