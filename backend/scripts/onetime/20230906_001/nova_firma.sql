...
SET @firma_pib = '02795060';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "MAJA E JEZERCES"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BREZOJEVICE BB.';
SET @firma_grad = 'PLAV';
SET @firma_drzava = 39;
SET @firma_telefon = '';
SET @firma_email = '';
...
SET @firma_cert_pass = 'gAAAAABk-BmYdFb9d_LX7z38CGb44rser8e7z1Xt3pDUufoOfdlGVFRev16toSw_vFLW_1bXGWqNmnZO-BBV_OQjjXVi7RJSqQ==';
...
SET @organizaciona_jedinica_efi_kod = 'fx524qt295';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'BREZOJEVICE BB';
SET @organizaciona_jedinica_grad = 'PLAV';
...
SET @naplatni_uredjaj_id = 'oh053av461';
...
SET @operater_kodoperatera = 'ry697vb053';
SET @operater_ime = 'HAXH GJONBALAJ';
SET @operater_korisnicko_ime = 'haxh';
SET @operater_lozinka = '$pbkdf2-sha256$29000$KoWQsrY2JoSwthaCMKZ07g$ncQMQPcXJQo9SCNJq/QC1B6/7pHydSoIKW0nqDfBtYw';
