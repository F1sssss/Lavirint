...
SET @firma_pib = '03023206';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "APROM"';
SET @firma_pdvbroj = '';
SET @firma_adresa = '29 NOVEMBAR BB.';
...
SET @organizaciona_jedinica_efi_kod = 'bt195wl267';
SET @organizaciona_jedinica_naziv = 'Kafe bar Daire';
SET @organizaciona_jedinica_adresa = 'GRADSKI TRG P.C. SOFIKO';
...
SET @naplatni_uredjaj_id = 'dx072bu231';
...
SET @operater_kodoperatera = 'zw071ry381';
SET @operater_ime = 'Senad Ramović';
SET @operater_korisnicko_ime = 'senad';
SET @operater_lozinka = '$pbkdf2-sha256$29000$4rz3fs8Zw7g3ZsyZMwZgrA$8tiWyVys1WZzNciRLvXNJWH9F1aUhpWFdyvhmLJbN88';
