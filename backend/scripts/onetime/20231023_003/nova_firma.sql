...
SET @firma_pib = '03519546';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "BOHEMIAN ZONE"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABlNnI63SHLfo7J8YpI5WfrZtbsWc6glvQoYnfGHAQtAjzJb5PjjDblWVt1dovIyei1ac1p7Or2elI340VJV97ZG8xnIA==';
...
SET @organizaciona_jedinica_efi_kod = 'bm578lq196';
...
SET @naplatni_uredjaj_id = 'tw600hg697';
...
SET @operater_kodoperatera = 'cr428yz273';
SET @operater_ime = 'ZOE MIKESKOVA';
SET @operater_korisnicko_ime = 'zoe';
SET @operater_lozinka = '$pbkdf2-sha256$29000$SYnR2rs3JgSA8J5zbi0l5A$EIw2IVulPoYddtroHa3.5Pq9vAfR7xtq3Z1IbDoH/Mc';
