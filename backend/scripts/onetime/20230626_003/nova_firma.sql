...
SET @firma_pib = '03485544';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'D.O.O. "LUCKY CAR.BD"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'LAZI BB';
...
SET @firma_cert_pass = 'gAAAAABkmeJO-FDE-8qg043ax3BWjFecOdXxJOegN3yPN4I2sE0d7g_9G3FpEoIjsGlx3qkzcQNCIJrVFGO_SXy0CRsTRnZyIA==';
...
SET @organizaciona_jedinica_efi_kod = 'mo210wp727';
SET @organizaciona_jedinica_adresa = 'LAZI BB';
...
SET @naplatni_uredjaj_id = 'wl716do934';
...
SET @operater_kodoperatera = 'qz214ye385';
SET @operater_ime = 'SERGEI LOSHKAREV';
SET @operater_korisnicko_ime = 'sergei';
SET @operater_lozinka = '$pbkdf2-sha256$29000$Rkjp3Vur1bq3tpYSQiiFkA$ZoWC28DcT9Ni0PNQlSINivqAUHMLqXVJFBTHuX2LXAk';
