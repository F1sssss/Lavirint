...
SET @firma_pib = '03423620';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "APIC WAYS"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'NIKOLE LJUBIBRATIĆA BB';
...
SET @firma_cert_pass = 'gAAAAABk0kJD5mhxD6-LVOh60nOpxVd6Vd9Q98GJOa5tZ64kBBz_aM1gmInI3r5ah1JsMzKtTOMar3vWwf1KVyFxgbpGeCj-Tg==';
...
SET @organizaciona_jedinica_efi_kod = 'jc604mq096';
SET @organizaciona_jedinica_naziv = '';
SET @organizaciona_jedinica_adresa = 'NIKOLE LJUBIBRATIĆA bb';
...
SET @naplatni_uredjaj_id = 'rh731qk619';
...
SET @operater_kodoperatera = 'td069my204';
SET @operater_ime = 'Vadim Shilov';
SET @operater_korisnicko_ime = 'vadim';
SET @operater_lozinka = '$pbkdf2-sha256$29000$jTEmREgJ4Xwvxbh3zvkf4w$P3wRzlIZuGThWXcWMvLL9NdH4mI5XKOtqTJNaaMCY5A';
