...
SET @firma_pib = '03327396';
SET @firma_je_poreski_obaveznik = 1;
SET @firma_naziv = 'D.O.O. "ALPHA GAMMA GROUP"';
SET @firma_pdvbroj = '';
SET @firma_adresa = 'BULEVAR SVETOG PETRA CETINJSKOG BR.65';
...
SET @organizaciona_jedinica_efi_kod = 'rp893be138';
SET @organizaciona_jedinica_naziv = 'CAPE MONTENEGRO';
SET @organizaciona_jedinica_adresa = 'KRIMOVICA BB';
SET @organizaciona_jedinica_grad = 'KOTOR';
...
SET @naplatni_uredjaj_id = 'ha517us596';
...
SET @operater_kodoperatera = 'am698by232';
SET @operater_ime = 'Roman Smolev';
SET @operater_korisnicko_ime = 'roman2';
SET @operater_lozinka = '$pbkdf2-sha256$29000$8n7Pee9dq5USwnjv3RsDYA$iyUxllrhDkg9u6X/UWG3SjU156TprdlBMP307.DK5Ks';
...
SET @operater_kodoperatera = 'so824da774';
SET @operater_ime = 'Sonja Ivanović';
SET @operater_korisnicko_ime = 'sonja2';
SET @operater_lozinka = '$pbkdf2-sha256$29000$U0qp9V7rvTcGoDSmtPaecw$9LhHVEbXYcIWCFPdDWIOkkje36bfNOI7pQEUYaVT690';
SET @operater_admin = 0;
SET @operater_aktivan = 1;
