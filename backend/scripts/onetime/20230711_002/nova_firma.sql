...
SET @firma_pib = '03520943';
SET @firma_je_poreski_obaveznik = 0;
SET @firma_naziv = 'DOO "INFINITY PROJECT"';
SET @firma_pdvbroj = '';
...
SET @firma_cert_pass = 'gAAAAABkrVWIPQeBPV_WakQixMSPidcYulh6WrUPwtD0_WgkHUtA5NOk1Z-KBEuGa8xwOL9UCDcvn5IhLMQmFGqU20A8H0LC_Q==';
...
SET @organizaciona_jedinica_efi_kod = 'au870zw228';
...
SET @naplatni_uredjaj_id = 'rs894rm576';
...
SET @operater_kodoperatera = 'cv960ao868';
SET @operater_ime = 'TUNA CANSU YUCEKAYA';
SET @operater_korisnicko_ime = 'tuna';
SET @operater_lozinka = '$pbkdf2-sha256$29000$/z8nhNDaW.v9X6t17l3rnQ$d9CxHv.CUKIq52t16pTCAYFj.I.eZbNOI7Smm3h9psw';
